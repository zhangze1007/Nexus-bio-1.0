 ...
 */
export function designCas12aGuides(
...
export function getCasVariantInfo(variant: CasVariant): {
  ...
  const info: Record<CasVariant, { name: string; pam: string; description: string; advantages: string[]; applications: string[] }> = {
    SpCas9: {
      name: 'SpCas9',
      pam: 'NGG',
