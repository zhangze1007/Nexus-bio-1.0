...
const MINIMAL_GENE_SET: GeneState[] = [
  ...
  {
    id: "dnaA",
    name: "DNA replication initiator",
    essential: true,
    copyNumber: 1,
    expressionRate: 0.5,
    degradationRate: 0.01,
    translationRate: 2,
    proteinDegradationRate: 0.005,
  },
  {
    id: "dnaB",
    name: "DNA helicase",
  ...
  {
    id: "rpsA",
    name: "30S ribosomal protein S1",
    essential: true,
    copyNumber: 10,
    expressionRate: 2.0,
    degradationRate: 0.002,
    translationRate: 5,
    proteinDegradationRate: 0.001,
  },
  {
    id: "rplA",
    name: "50S ribosomal protein L1",
    essential: true,
    copyNumber: 10,
    expressionRate: 2.0,
    degradationRate: 0.002,
  ...
  {
    id: "infA",
    name: "Translation initiation IF1",
    essential: true,
    copyNumber: 5,
    expressionRate: 1.0,
    degradationRate: 0.005,
  ...
  {
    id: "tsf",
    name: "Translation elongation Ts",
    essential: true,
    copyNumber: 5,
    expressionRate: 1.0,
    degradationRate: 0.005,
  ...
  // Enzyme kinetics: kcat/Km from BRENDA (https://www.brenda-enzymes.org)
  {
    ...
    translationRate: 2.5,
    proteinDegradationRate: 0.002,
    catalyticActivity: { kcat: 200, km: 0.3, substrates: ["glucose", "atp"], products: ["g6p", "adp"] },
  }, // BRENDA EC 2.7.1.1: kcat=200/s, Km=0.3 mM (PMID:10094)
  {
    id: "pgi",
    name: "Glucose-6-P isomerase",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.6,
    degradationRate: 0.005,
    translationRate: 2,
    proteinDegradationRate: 0.002,
    catalyticActivity: { kcat: 250, km: 0.5, substrates: ["g6p"], products: ["f6p"] },
  }, // BRENDA EC 5.3.1.9: kcat=250/s, Km=0.5 mM
  {
    id: "pfkA",
    ...
    translationRate: 1.5,
    proteinDegradationRate: 0.002,
    catalyticActivity: { kcat: 150, km: 0.2, substrates: ["f6p", "atp"], products: ["fdp", "adp"] },
  }, // BRENDA: kcat ~100-200/s, Km ~0.1-0.3 mM
  {
    id: "pykF",
    ...
    translationRate: 3,
    proteinDegradationRate: 0.002,
    catalyticActivity: { kcat: 300, km: 0.3, substrates: ["pep", "adp"], products: ["pyr", "atp"] },
  }, // BRENDA: kcat ~200-400/s, Km ~0.1-0.5 mM
  {
    id: "aceE",
    ...
    translationRate: 1.5,
    proteinDegradationRate: 0.002,
    catalyticActivity: { kcat: 40, km: 0.5, substrates: ["pyr", "coa", "nad"], products: ["accoa", "co2", "nadh"] },
  }, // BRENDA EC 1.2.4.1: kcat=40/s, Km=0.5 mM
  ...
  // kcat/Km from BRENDA (https://www.brenda-enzymes.org)
  {
    ...
    translationRate: 1.5,
    proteinDegradationRate: 0.002,
    catalyticActivity: { kcat: 80, km: 0.01, substrates: ["accoa", "oaa"], products: ["cit", "coa"] },
  }, // BRENDA EC 2.3.3.1: kcat=80/s, Km(OAA)=0.01 mM
  {
    id: "icdA",
    ...
    translationRate: 1,
    proteinDegradationRate: 0.002,
    catalyticActivity: { kcat: 60, km: 0.2, substrates: ["icit", "nadp"], products: ["akg", "co2", "nadph"] },
  }, // BRENDA: kcat ~20-80/s, Km ~0.01-0.2 mM
  {
    id: "sucA",
    name: "α-KG dehydrogenase",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.3,
    degradationRate: 0.005,
    translationRate: 1,
    proteinDegradationRate: 0.002,
    catalyticActivity: { kcat: 40, km: 0.3, substrates: ["akg", "coa", "nad"], products: ["succoa", "co2", "nadh"] },
  }, // BRENDA: kcat ~20-60/s, Km ~0.1-0.5 mM

  // Membrane / Transport (3 genes)
  {
    id: "ptsG",
    name: "PTS glucose transporter",
    essential: true,
    copyNumber: 5,
    expressionRate: 1.5,
    degradationRate: 0.005,
  ...
  {
    id: "minC",
    name: "Cell division inhibitor MinC",
    essential: true,
    copyNumber: 5,
    expressionRate: 0.3,
    degradationRate: 0.01,
  ...
  {
    id: "pheS",
    name: "Phenylalanyl-tRNA synthetase α",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.4,
    degradationRate: 0.005,
  ...
  {
    id: "pheT",
    name: "Phenylalanyl-tRNA synthetase β",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.4,
    degradationRate: 0.005,
  ...
  {
    id: "greA",
    name: "Transcription cleavage factor",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "accB",
    name: "Acetyl-CoA carboxylase BCCP",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "fabB",
    name: "β-Ketoacyl-ACP synthase I",
    essential: true,
    copyNumber: 3,
    expressionRate: 0.4,
    degradationRate: 0.005,
  ...
  {
    id: "lpxA",
    name: "UDP-GlcNAc acyltransferase",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "lpxC",
    name: "UDP-3-O-acyl-GlcNAc deacetylase",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "glnH",
    name: "Glutamine binding protein",
    essential: true,
    copyNumber: 3,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "hisJ",
    name: "Histidine binding protein",
    essential: false,
    copyNumber: 3,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "tsr",
    name: "Methyl-accepting chemotaxis",
    essential: false,
    copyNumber: 5,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "leuB",
    name: "Isopropylmalate dehydrogenase",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "leuC",
    name: "Isopropylmalate isomerase",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "hisI",
    name: "Imidazole glycerol-phosphate dehydratase",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "hemB",
    name: "Aminolevulinic acid dehydratase",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "murA",
    name: "UDP-GlcNAc enolpyruvyl transferase",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "murD",
    name: "UDP-MurNAc-Ala-D-Glu ligase",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "murE",
    name: "UDP-MurNAc-tripeptide ligase",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "murF",
    name: "UDP-MurNAc-pentapeptide ligase",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "murG",
    name: "Lipid II GlcNAc transferase",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "mraY",
    name: "Phospho-MurNAc-pentapeptide transferase",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "phoB",
    name: "Phosphate regulon response regulator",
    essential: false,
    copyNumber: 3,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "phoR",
    name: "Phosphate regulon sensor kinase",
    essential: false,
    copyNumber: 3,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "ompR",
    name: "Osmolarity response regulator",
    essential: false,
    copyNumber: 3,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "cpxA",
    name: "Cpx envelope stress sensor",
    essential: false,
    copyNumber: 3,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "arcB",
    name: "Aerobic respiration control",
    essential: false,
    copyNumber: 3,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "arcA",
    name: "Aerobic respiration regulator",
    essential: false,
    copyNumber: 3,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "rpsJ",
    name: "30S ribosomal protein S10",
    essential: true,
    copyNumber: 10,
    expressionRate: 1.5,
    degradationRate: 0.002,
  ...
  {
    id: "rpsO",
    name: "30S ribosomal protein S15",
    essential: true,
    copyNumber: 10,
    expressionRate: 1.5,
    degradationRate: 0.002,
  ...
  {
    id: "rpsQ",
    name: "30S ribosomal protein S17",
    essential: true,
    copyNumber: 10,
    expressionRate: 1.5,
    degradationRate: 0.002,
  ...
  {
    id: "rpsR",
    name: "30S ribosomal protein S18",
    essential: true,
    copyNumber: 10,
    expressionRate: 1.5,
    degradationRate: 0.002,
  ...
  {
    id: "rpsT",
    name: "30S ribosomal protein S20",
    essential: true,
    copyNumber: 10,
    expressionRate: 1.5,
    degradationRate: 0.002,
  ...
  {
    id: "rpsU",
    name: "30S ribosomal protein S21",
    essential: false,
    copyNumber: 5,
    expressionRate: 0.5,
    degradationRate: 0.005,
  ...
  {
    id: "sra",
    name: "30S ribosomal protein S22",
    essential: false,
    copyNumber: 5,
    expressionRate: 0.5,
    degradationRate: 0.005,
  ...
  {
    id: "rpsY",
    name: "30S ribosomal protein S23",
    essential: false,
    copyNumber: 5,
    expressionRate: 0.5,
    degradationRate: 0.005,
  ...
  {
    id: "rplL",
    name: "50S ribosomal protein L12",
    essential: true,
    copyNumber: 10,
    expressionRate: 1.5,
    degradationRate: 0.002,
  ...
  {
    id: "rplO",
    name: "50S ribosomal protein L15",
    essential: true,
    copyNumber: 10,
    expressionRate: 1.5,
    degradationRate: 0.002,
  ...
  {
    id: "rplQ",
    name: "50S ribosomal protein L17",
    essential: true,
    copyNumber: 10,
    expressionRate: 1.5,
    degradationRate: 0.002,
  ...
  {
    id: "rplR",
    name: "50S ribosomal protein L18",
    essential: true,
    copyNumber: 10,
    expressionRate: 1.5,
    degradationRate: 0.002,
  ...
  {
    id: "rplS",
    name: "50S ribosomal protein L19",
    essential: true,
    copyNumber: 10,
    expressionRate: 1.5,
    degradationRate: 0.002,
  ...
  {
    id: "rplW",
    name: "50S ribosomal protein L23",
    essential: true,
    copyNumber: 10,
    expressionRate: 1.5,
    degradationRate: 0.002,
  ...
  {
    id: "rplX",
    name: "50S ribosomal protein L24",
    essential: true,
    copyNumber: 10,
    expressionRate: 1.5,
    degradationRate: 0.002,
  ...
  {
    id: "rpmB",
    name: "50S ribosomal protein L28",
    essential: true,
    copyNumber: 10,
    expressionRate: 1.5,
    degradationRate: 0.002,
  ...
  {
    id: "rpmC",
    name: "50S ribosomal protein L29",
    essential: true,
    copyNumber: 10,
    expressionRate: 1.5,
    degradationRate: 0.002,
  ...
  {
    id: "rpmF",
    name: "50S ribosomal protein L32",
    essential: true,
    copyNumber: 10,
    expressionRate: 1.5,
    degradationRate: 0.002,
  ...
  {
    id: "rpmH",
    name: "50S ribosomal protein L34",
    essential: true,
    copyNumber: 10,
    expressionRate: 1.5,
    degradationRate: 0.002,
  ...
  {
    id: "rpmJ",
    name: "50S ribosomal protein L36",
    essential: true,
    copyNumber: 10,
    expressionRate: 1.5,
    degradationRate: 0.002,
  ...
  {
    id: "hisP",
    name: "Histidine ABC transporter ATPase",
    essential: false,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "livG",
    name: "Leucine ABC transporter ATPase",
    essential: false,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "malK",
    name: "Maltose ABC transporter ATPase",
    essential: false,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "oppD",
    name: "Oligopeptide ABC transporter ATPase",
    essential: false,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "cysA",
    name: "Sulfate ABC transporter ATPase",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "aceK",
    name: "Isocitrate dehydrogenase kinase",
    essential: false,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "sucA",
    name: "α-Ketoglutarate dehydrogenase E1",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "sucB",
    name: "α-Ketoglutarate dehydrogenase E2",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "sucC",
    name: "Succinyl-CoA synthetase α",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "sucD",
    name: "Succinyl-CoA synthetase β",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "sdhA",
    name: "Succinate dehydrogenase flavoprotein",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "sdhB",
    name: "Succinate dehydrogenase iron-sulfur",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "sdhC",
    name: "Succinate dehydrogenase membrane",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "pflA",
    name: "Pyruvate formate-lyase activating",
    essential: false,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "ihfA",
    name: "Integration host factor α",
    essential: true,
    copyNumber: 5,
    expressionRate: 0.5,
    degradationRate: 0.005,
  ...
  {
    id: "ihfB",
    name: "Integration host factor β",
    essential: true,
    copyNumber: 5,
    expressionRate: 0.5,
    degradationRate: 0.005,
  ...
  {
    id: "fis",
    name: "Factor for inversion stimulation",
    essential: false,
    copyNumber: 5,
    expressionRate: 0.5,
    degradationRate: 0.005,
  ...
  {
    id: "hns",
    name: "Histone-like nucleoid structuring",
    essential: true,
    copyNumber: 10,
    expressionRate: 1.0,
    degradationRate: 0.002,
  ...
  {
    id: "dps",
    name: "DNA protection during starvation",
    essential: false,
    copyNumber: 5,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "oxyR",
    name: "Oxidative stress regulator",
    essential: false,
    copyNumber: 3,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "soxR",
    name: "Superoxide response regulator",
    essential: false,
    copyNumber: 3,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "marA",
    name: "Multiple antibiotic resistance",
    essential: false,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "glnK",
    name: "PII signal transduction protein",
    essential: false,
    copyNumber: 3,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "ntrB",
    name: "Nitrogen regulation sensor",
    essential: false,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "ntrC",
    name: "Nitrogen regulation response",
    essential: false,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "narJ",
    name: "Nitrate reductase molybdenum",
    essential: false,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "narK",
    name: "Nitrate/nitrite transporter",
    essential: false,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "nifA",
    name: "Nitrogen fixation regulator",
    essential: false,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "sufC",
    name: "Fe-S cluster assembly ATPase",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "fnr",
    name: "Fumarate nitrate reduction regulator",
    essential: false,
    copyNumber: 3,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "arcB",
    name: "Aerobic respiration sensor",
    essential: false,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "marR",
    name: "Multiple antibiotic resistance repressor",
    essential: false,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "rpoS",
    name: "Stationary phase sigma factor",
    essential: false,
    copyNumber: 3,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "rpoE",
    name: "Extracytoplasmic sigma factor",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "ftsK",
    name: "Cell division protein FtsK",
    essential: true,
    copyNumber: 3,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "ftsQ",
    name: "Cell division protein FtsQ",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "ftsN",
    name: "Cell division protein FtsN",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "ftsB",
    name: "Cell division protein FtsB",
    essential: true,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "minE",
    name: "Min system topological specificity",
    essential: true,
    copyNumber: 3,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "seqA",
    name: "Negative regulator of replication",
    essential: false,
    copyNumber: 3,
    expressionRate: 0.3,
    degradationRate: 0.005,
  ...
  {
    id: "hsdR",
    name: "Type I restriction enzyme",
    essential: false,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "hsdM",
    name: "Type I restriction methyltransferase",
    essential: false,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "hsdS",
    name: "Type I restriction specificity",
    essential: false,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "mcrA",
    name: "Modified cytosine restriction",
    essential: false,
    copyNumber: 2,
    expressionRate: 0.2,
    degradationRate: 0.01,
  ...
  {
    id: "rho",
    name: "Transcription termination factor",
    essential: true,
    copyNumber: 5,
    expressionRate: 0.5,
    degradationRate: 0.005,
...
export function simulateDigitalCell(config: SimulationConfig, initialState?: Partial<CellState>): SimulationResult {
  ...
  for (let step = 0; step <= steps; step++) {
    ...
    // === 5. Growth ===
    const glucoseUptake =
      ((proteins["ptsG"] || 0) * 0.01 * (metabolites.glucose || 0)) / (0.5 + (metabolites.glucose || 0));
  ...
  // Compute metrics
  const avgGrowthRate =
    timeSeries.length > 0 ? timeSeries.reduce((s, t) => s + t.growthRate, 0) / timeSeries.length : 0;
