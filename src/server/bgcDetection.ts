...
const DOMAIN_PROFILES: DomainProfile[] = [
  // NRPS domains
  {
    name: "AMP-binding",
    type: "NRPS",
    keywords: ["AMP-binding", "adenylation", "A-domain"],
    minLength: 400,
    maxLength: 600,
    weight: 1.0,
  },
  {
    name: "PCP",
    type: "NRPS",
    keywords: ["PCP", "peptidyl-carrier", "T-domain"],
    minLength: 80,
    maxLength: 120,
    weight: 0.8,
  },
  {
    name: "C-domain",
    type: "NRPS",
    keywords: ["condensation", "C-domain"],
    minLength: 400,
    maxLength: 500,
    weight: 0.9,
  },
  {
    name: "TE-domain",
    type: "NRPS",
    keywords: ["thioesterase", "TE-domain"],
    minLength: 250,
    maxLength: 350,
    weight: 0.7,
  },
  {
    name: "E-domain",
    type: "NRPS",
    keywords: ["epimerization", "E-domain"],
    minLength: 400,
    maxLength: 500,
    weight: 0.6,
  },
  ...
  // PKS domains
  {
    name: "KS",
    type: "PKS",
    keywords: ["ketosynthase", "KS-domain", "beta-ketoacyl"],
    minLength: 400,
    maxLength: 500,
    weight: 1.0,
  },
  {
    name: "AT",
    type: "PKS",
    keywords: ["acyltransferase", "AT-domain", "malonyl"],
    minLength: 300,
    maxLength: 400,
    weight: 0.9,
  },
  ...
  // Terpene
  {
    name: "TPS",
    type: "terpene",
    keywords: ["terpene_synthase", "TPS", "cyclase"],
    minLength: 300,
    maxLength: 800,
    weight: 1.0,
  },
  ...
  // RiPP
  {
    name: "Lant_dehydr",
    type: "lantipeptide",
    keywords: ["lant_dehydr", "LanM", "dehydratase"],
    minLength: 800,
    maxLength: 1200,
    weight: 1.0,
  },
  ...
  // Siderophore
  {
    name: "IucA",
    type: "siderophore",
    keywords: ["IucA", "IucC", "siderophore"],
    minLength: 400,
    maxLength: 600,
    weight: 1.0,
  },
  {
    name: "NRPS-like",
    type: "siderophore",
    keywords: ["NRPS-like", "siderophore"],
    minLength: 300,
    maxLength: 500,
    weight: 0.7,
  },
...
export function detectBGCs(
  ...
  const coreGenes = geneScores.filter((gs) => gs.score >= 0.7).map((gs) => gs.gene);
...
function clusterGenesIntoRegions(
  ...
  for (const region of regions) {
    region.genes = allGenes.filter((g) => g.start >= region.start && g.end <= region.end);
  }
