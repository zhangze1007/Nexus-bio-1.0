...
export function toSBOL3(construct: {
  ...
  return {
    ...
    components: [
      {
        uri: `https://nexus-bio.com/part/promoter_${Date.now()}`,
        name: "Promoter",
        role: "promoter",
        sequence: {
          uri: `https://nexus-bio.com/seq/promo_${Date.now()}`,
          elements: construct.promoter,
          type: "DNA",
          encoding: "iupac_dna",
        },
      },
      {
        uri: `https://nexus-bio.com/part/rbs_${Date.now()}`,
        name: "RBS",
        role: "ribosome_binding_site",
        sequence: {
          uri: `https://nexus-bio.com/seq/rbs_${Date.now()}`,
          elements: construct.rbs,
          type: "RNA",
          encoding: "iupac_rna",
        },
      },
      {
        uri: `https://nexus-bio.com/part/cds_${Date.now()}`,
        name: "CDS",
        role: "coding_sequence",
        sequence: {
          uri: `https://nexus-bio.com/seq/cds_${Date.now()}`,
          elements: construct.cds,
          type: "DNA",
          encoding: "iupac_dna",
        },
      },
      {
        uri: `https://nexus-bio.com/part/term_${Date.now()}`,
        name: "Terminator",
        role: "terminator",
        sequence: {
          uri: `https://nexus-bio.com/seq/term_${Date.now()}`,
          elements: construct.terminator,
          type: "DNA",
          encoding: "iupac_dna",
        },
      },
