export const PATHD_THEME = {
  ...
  paperBorder: 'rgba(34, 40, 48, 0.09)',
  paperBorderStrong: 'rgba(34, 40, 48, 0.16)',
  paperSurface: 'rgba(251, 248, 244, 0.92)',
  paperSurfaceStrong: 'rgba(248, 243, 237, 0.96)',
  paperSurfaceMuted: 'rgba(240, 234, 226, 0.9)',
  paperLabel: 'rgba(78, 85, 95, 0.76)',
  paperValue: '#20252B',
  paperMuted: 'rgba(78, 85, 95, 0.58)',
  sepiaPanel: '#EFE8DE',
  sepiaPanelStrong: '#E8E0D6',
  sepiaPanelMuted: '#F5F1EB',
  sepiaPanelBorder: 'rgba(34, 40, 48, 0.12)',
