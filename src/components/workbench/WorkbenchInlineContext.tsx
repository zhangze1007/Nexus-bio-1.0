    ...
    >
      <div style={{ display: 'flex', alignItems: compact ? 'flex-start' : 'center', justifyContent: 'space-between', gap: compact ? '10px' : '8px', flexWrap: 'wrap' }}>
        <div style={{ display: 'grid', gap: '4px' }}>
          <span style={{ fontFamily: THEME.MONO, fontSize: '10px', color: LABEL, textTransform: 'uppercase', letterSpacing: '0.1em' }}>
      ...
      {compact ? (
          ...
          {compactItems.map((item) => (
            ...
            >
              <span
                ...
                style={{ fontFamily: THEME.MONO, fontSize: '10px', color: LABEL, textTransform: 'uppercase', letterSpacing: '0.08em' }}
              >
                {item.label}
              </span>
              <span
        ...
        <div style={{ display: 'grid', gap: '8px', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))' }}>
          <div>
            <div style={{ fontFamily: THEME.MONO, fontSize: '10px', color: LABEL, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: '4px' }}>
              Evidence
            </div>
