...
function ProteinCanvas({ pdbId, alphafoldId, name, useAlphaFold }: ProteinCanvasProps) {
  ...
  const residueInfo = tooltip
    ? RESIDUE_TYPE_INFO[tooltip.resn] || { color: "#888", role: `${tooltip.resn} residue` }
    : null;
      ...
      {status === "error" && (
        ...
        >
          ...
          <a
            ...
            style={{ color: "#6495ED", fontSize: "11px" }}
          >
            Open in RCSB →
          </a>
        </div>
          ...
          {tooltip.b > 0 && (
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "3px" }}>
                ...
                <span
                  style={{ color: getPLDDTColor(tooltip.b), fontSize: "10px", fontFamily: THEME.MONO, fontWeight: 700 }}
                >
                  {tooltip.b.toFixed(1)}
                </span>
              </div>
              <div style={{ width: "100%", height: "3px", background: "rgba(255,255,255,0.08)", borderRadius: "2px" }}>
                <div
                  style={{
                    width: `${Math.min(tooltip.b, 100)}%`,
                    height: "100%",
                    background: getPLDDTColor(tooltip.b),
                    borderRadius: "2px",
      ...
      {status === "ready" && (
        <>
          ...
          >
            ...
            >
              <span
                style={{ color: "rgba(255,255,255,0.75)", fontSize: "10px", fontFamily: THEME.MONO, fontWeight: 700 }}
              >
      ...
      <div className="max-w-5xl mx-auto">
        <div className="mb-10">
          ...
          <p style={{ color: "rgba(255,255,255,0.55)", fontSize: "14px" }}>
            Real 3D structures from <span style={{ color: "#6495ED", fontFamily: THEME.MONO }}>RCSB PDB</span> ·{" "}
            <span style={{ color: "#65CBF3", fontFamily: THEME.MONO }}>AlphaFold DB</span> · Hover any atom for
            biochemical data
          </p>
        </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            ...
            {PATHWAY_ENZYMES.map((enzyme) => (
              <button
                ...
                style={{
                  ...
                  cursor: "pointer",
                  background:
                    activeEnzyme.id === enzyme.id && !customActive
                ...
                onMouseEnter={(e) => {
                  if (activeEnzyme.id !== enzyme.id || customActive)
              ...
              >
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "3px" }}>
                  <span style={{ color: "#6495ED", fontSize: "11px", fontFamily: THEME.MONO, fontWeight: 700 }}>
                    {enzyme.name}
                  </span>
                  <span style={{ color: "rgba(255,255,255,0.2)", fontSize: "10px", fontFamily: THEME.MONO }}>
                    {enzyme.pdbId}
                  </span>
                </div>
                <p style={{ color: "rgba(255,255,255,0.55)", fontSize: "12px", fontWeight: 500, margin: "0 0 2px" }}>
                  {enzyme.fullName}
                </p>
                <p style={{ color: "rgba(255,255,255,0.45)", fontSize: "10px", margin: 0, fontStyle: "italic" }}>
                  {enzyme.organism}
                </p>
              </button>
            ))}
            ...
            <div style={{ borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: "10px" }}>
              ...
              <div style={{ display: "flex", gap: "6px" }}>
                ...
                <button
                  onClick={() => {
                    if (customPDB.length === 4) setCustomActive(true);
                  }}
                  disabled={customPDB.length !== 4}
                  style={{
                    padding: "8px 12px",
                    background: customPDB.length === 4 ? "rgba(147,203,82,0.15)" : "rgba(255,255,255,0.05)",
                    color: customPDB.length === 4 ? "rgba(147,203,82,0.9)" : "rgba(255,255,255,0.2)",
                    borderRadius: "8px",
                    border:
                      customPDB.length === 4 ? "1px solid rgba(147,203,82,0.4)" : "1px solid rgba(255,255,255,0.08)",
                    fontSize: "12px",
                    fontWeight: 600,
                    cursor: customPDB.length === 4 ? "pointer" : "not-allowed",
                    transition: "all 0.15s",
                  }}
                >
                  Load
            ...
            >
              <div>
                ...
                <p style={{ color: "rgba(255,255,255,0.45)", fontSize: "10px", fontFamily: THEME.MONO, margin: 0 }}>
              ...
              <button
                ...
                style={{
                  ...
                  height: "20px",
                  borderRadius: "12px",
                  background: useAlphaFold ? "#6495ED" : "rgba(255,255,255,0.1)",
                  border: "none",
                  cursor: "pointer",
                  position: "relative",
