          ...
          >
            <div
              style={{
                ...
                height: 30,
                borderRadius: 10,
                background: collapsed ? "rgba(255,255,255,0.08)" : "rgba(231,199,169,0.14)",
                border: collapsed ? `1px solid ${BORDER}` : "1px solid rgba(231,199,169,0.22)",
                display: "grid",
                placeItems: "center",
                flexShrink: 0,
              }}
            ...
            >
              <div style={{ fontFamily: BRAND, fontSize: 13, fontWeight: 700, color: VALUE }}>Nexus-Bio</div>
              <div style={{ fontFamily: SANS, fontSize: 10, color: LABEL }}>Tools Directory</div>
            </motion.div>
          </Link>
        </div>
                      ...
                      >
                        ...
                        <div
                          style={{
                            ...
                            display: "grid",
                            placeItems: "center",
                            background: isActive ? `${stage.accent}55` : PATHD_THEME.panelGlassStrong,
                            border: isActive ? `1px solid ${stage.accent}` : `1px solid ${BORDER}`,
                            flexShrink: 0,
                          }}
                        >
          ...
          >
            ...
            <div style={{ display: "grid", gap: 6, justifyItems: collapsed ? "center" : undefined }}>
              {TOOL_DEFINITIONS.filter((tool) =>
                CROSS_STAGE_TOOL_IDS.includes(tool.id as (typeof CROSS_STAGE_TOOL_IDS)[number]),
              ).map((tool, crossIndex) => {
                const Icon = tool.icon;
                const isActive = pathname?.startsWith(tool.href);
                  ...
                  >
                    <div
                      style={{
                        ...
                        display: "grid",
                        placeItems: "center",
                        background: isActive ? "rgba(207,196,227,0.4)" : PATHD_THEME.panelGlassStrong,
                        border: isActive ? "1px solid rgba(207,196,227,0.5)" : `1px solid ${BORDER}`,
                        flexShrink: 0,
                      }}
                    >
                      <Icon size={14} style={{ color: isActive ? VALUE : LABEL }} />
                    ...
                    <motion.div
                      ...
                      transition={{
                        duration: collapsed ? 0.1 : 0.2,
                        delay: collapsed ? 0 : 0.06 + crossIndex * 0.025,
                        ease: "easeOut",
                      }}
                      aria-hidden={collapsed}
                      style={{
