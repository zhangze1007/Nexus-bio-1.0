...
import { buildWorkbenchCopilotContext, type ConversationTurn, composeCopilotQuery } from "../../services/axonContext";
...
export default function CopilotSlideOver() {
  ...
  const workbenchContext = useMemo(
    ...
    [project, analyzeArtifact, evidenceItems, selectedEvidenceIds, nextRecommendations, currentToolId],
  );
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  borderRadius: "12px",
                  border: `1px solid ${
                    workbenchContext.hasContext ? "rgba(175,195,214,0.32)" : "rgba(255,255,255,0.06)"
                  }`,
                  background: workbenchContext.hasContext ? "rgba(175,195,214,0.08)" : "transparent",
                  fontFamily: THEME.MONO,
                  fontSize: "10px",
                  color: workbenchContext.hasContext ? THEME.VALUE : THEME.LABEL,
                  lineHeight: 1.4,
                }}
              >
                <span
                  ...
                  style={{
                    ...
                    height: "6px",
                    borderRadius: "50%",
                    background: workbenchContext.hasContext ? THEME.SKY : "rgba(175,195,214,0.28)",
                    flexShrink: 0,
                  }}
                />
            ...
            >
              ...
              {messages.map((msg, i) => (
                <div
                  ...
                  style={{
                    borderRadius: "12px",
                    background: msg.role === "user" ? "rgba(175, 195, 214, 0.12)" : THEME.PANEL_GLASS_STRONG,
                    border: `1px solid ${msg.role === "user" ? "rgba(175, 195, 214, 0.15)" : THEME.BORDER}`,
                    padding: "12px 14px",
