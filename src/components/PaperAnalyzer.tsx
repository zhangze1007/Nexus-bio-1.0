...
// ── Structured prompt for evidence-aware pathway generation ──
const buildPrompt = (content: string) => `You are a computational biology expert specializing in metabolic pathway analysis.

Analyze the provided research content and extract a structured metabolic pathway.
  ...
  "nodes": [
    {
      "id": "acetyl_coa",
      "label": "Acetyl-CoA",
      "canonicalLabel": "Acetyl coenzyme A",
      "nodeType": "metabolite",
      "summary": "Central metabolic intermediate...",
      "evidenceSnippet": "Direct quote or close paraphrase from the text supporting this node",
  ...
  "edges": [
    {
      ...
      "direction": "forward",
      "evidence": "Text evidence for this reaction",
...
Rules:
- Extract 4–8 nodes maximum
- nodeType must be one of: metabolite, enzyme, gene, complex, cofactor, unknown
- relationshipType must be one of: catalyzes, produces, consumes, activates, inhibits, converts, transports, regulates, unknown
- IDs: lowercase, underscores only, no spaces
- Labels: 1–4 words, use standard biochemical nomenclature
- evidenceSnippet: must be grounded in the provided text, not fabricated
- confidenceScore: 0.0–1.0 based on how explicitly the source text supports this element
- Only include what the text explicitly states or strongly implies
