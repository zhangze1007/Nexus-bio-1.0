...
Rules: 4-8 nodes, IDs lowercase with underscores, labels 1-3 words max.`;
  ...
  const handleAnalyze = async () => {
    ...
    if (!hasContent) {
      setError(
        mode === 'text'
          ? 'Paste at least a sentence of text.'
          : mode === 'web'
            ? 'Enter a valid URL.'
            : 'Upload a file first.'
      );
    ...
    try {
      ...
      if (n === 0) {
        throw new Error('No pathway nodes returned');
      }
      ...
      if (message.includes('429')) {
        ...
        setError('Unexpected AI format. Try again.');
      } else {
        setError(message);
      }
    } finally {
  ...
  return (
    <section className="px-4 py-24" id="analyzer" style={{ borderTop: 'none' }}>
        ...
        <div className="mb-10 text-center">
          ...
          <p className="text-sm" style={{ color: 'rgba(255,255,255,0.35)' }}>
            ...
            <span style={{ color: 'rgba(255,255,255,0.55)' }}>
              AI extracts the metabolic architecture instantly.
            </span>
          </p>
        </div>
          ...
          <div className="px-3 py-3 flex items-center justify-between">
            <div className="flex items-center gap-1">
              ...
              <button
                ...
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLElement).style.color = expanded ? 'rgba(255,255,255,0.7)' : 'rgba(255,255,255,0.3)';
                  (e.currentTarget as HTMLElement).style.background = 'transparent';
                }}
              >
