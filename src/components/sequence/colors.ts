...
export const AA_COLORS: Record<string, string> = {
  ...
  A: '#C8D8E8', V: '#C8D8E8', L: '#C8D8E8', I: '#C8D8E8',
  M: '#C8D8E8', F: '#C8D8E8', W: '#C8D8E8', P: '#C8D8E8',
  // Polar / uncharged
  G: '#C8E0D0', S: '#C8E0D0', T: '#C8E0D0', C: '#C8E0D0',
  Y: '#C8E0D0', N: '#C8E0D0', Q: '#C8E0D0',
  // Positive
  K: '#5151CD', R: '#5151CD', H: '#5151CD',
  // Negative
  D: '#FA8072', E: '#FA8072',
  // Stop
  '*': '#DDD0E8',
