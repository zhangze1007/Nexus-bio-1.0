...
import { AlertCircle, ChevronLeft, ChevronRight, ExternalLink, Loader2, Microscope } from "lucide-react";
...
function detectImagingMethod(text: string): string {
  ...
  if (t.includes("electron") || t.includes(" em ") || t.includes("tem") || t.includes("sem"))
              ...
              return (
                <span
                  ...
                  style={{
                    ...
                    padding: "1px 5px",
                    borderRadius: "8px",
                    border: `1px solid ${SOURCE_COLORS[src]}`,
              ...
              {[
                {
                  ...
                  url: `https://cellimagelibrary.org/images/search?simple_search=${encodeURIComponent(searchTerm)}`,
                },
                {
                  label: "EMBL-EBI IDR",
                  url: `https://idr.openmicroscopy.org/search/?query=name:${encodeURIComponent(searchTerm)}`,
                },
              ].map((db) => (
                <a
                  key={db.label}
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                {current.imagingMethod && (
                  <span
                    style={{
                      color: SOURCE_COLORS[current.source] || "rgba(255,255,255,0.4)",
                      fontSize: "10px",
                      fontFamily: THEME.SANS,
                      fontFeatureSettings: "'tnum' 1",
                      padding: "1px 5px",
                      border: `1px solid ${SOURCE_COLORS[current.source] || "rgba(255,255,255,0.2)"}`,
                      borderRadius: "8px",
                    }}
                  >
                    {current.imagingMethod}
      ...
      {status === "ready" && current && (
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "10px" }}>
          ...
          <a
            ...
            rel="noopener noreferrer"
            style={{
              color: SOURCE_COLORS[current.source] || "rgba(255,255,255,0.3)",
              fontSize: "10px",
              fontFamily: THEME.SANS,
              fontFeatureSettings: "'tnum' 1",
              display: "flex",
          ...
          {images.map((img, i) => (
            <button
              ...
              style={{
                ...
                borderRadius: "12px",
                overflow: "hidden",
                border: `2px solid ${i === currentIdx ? SOURCE_COLORS[img.source] || "rgba(255,255,255,0.4)" : "rgba(255,255,255,0.06)"}`,
                background: "#0a0a0a",
                cursor: "pointer",
                padding: 0,
                position: "relative",
            ...
            >
              {imgError[img.id] ? (
                ...
                >
                  <Microscope size={12} style={{ color: "rgba(255,255,255,0.2)" }} />
                </div>
              ) : (
                <img
