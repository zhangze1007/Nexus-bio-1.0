      ...
      try {
        ...
        if (useAF) {
          try {
            ...
            await new Promise<void>((resolve, reject) => {
              const timer = setTimeout(() => reject(new Error("PDB download timeout")), 15000);
              window.$3Dmol.download(`pdb:${pdbId}`, viewer2, {}, () => {
                clearTimeout(timer);
                resolve();
              });
            });
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
        ...
        {status === "ready" && (
          <>
            ...
            <div style={{ position: "absolute", bottom: "8px", right: "10px" }}>
              <a
                href={
                  useAF ? `https://alphafold.ebi.ac.uk/entry/${alphafoldId}` : `https://www.rcsb.org/structure/${pdbId}`
                }
                target="_blank"
                ...
                onMouseEnter={(e) => {
                  (e.currentTarget as HTMLElement).style.color = "rgba(200,232,240,0.9)";
                }}
                onMouseLeave={(e) => {
      ...
      {alphafoldId && (
        ...
        >
          <div>
            <p style={{ color: "rgba(255,255,255,0.45)", fontSize: "11px", fontWeight: 500, margin: "0 0 2px" }}>
              AlphaFold pLDDT
            </p>
            <p
              style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            <button
              ...
              style={{
                ...
                borderRadius: "999px",
                border: "1px solid rgba(255,255,255,0.08)",
                background: spinEnabled ? "rgba(255,255,255,0.1)" : "transparent",
                color: "rgba(255,255,255,0.7)",
                fontSize: "10px",
                cursor: "pointer",
              }}
            ...
            <button
              onClick={() => setUseAF(!useAF)}
              style={{
                width: "34px",
                height: "18px",
                borderRadius: "8px",
                background: useAF ? "#A8C5DA" : "rgba(255,255,255,0.1)",
                border: "none",
                cursor: "pointer",
                position: "relative",
      ...
      >
        Drag to rotate · {spinEnabled ? "auto-spin on" : "manual view"} ·{" "}
        {renderMode === "surface"
          ? "surface envelope"
          : renderMode === "confidence"
            ? "confidence coloring"
