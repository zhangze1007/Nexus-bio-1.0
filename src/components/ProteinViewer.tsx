  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
        ...
        {status === 'loading' && (
          <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#0d0f14', gap: '12px', overflow: 'hidden' }}>
            ...
            <div style={{ textAlign: 'center' }}>
              <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '11px', fontFamily: THEME.SANS, fontWeight: 600, margin: '0 0 3px' }}>
                {useAF ? 'Predicting structure' : 'Loading structure'}
              </p>
              <p style={{ color: 'rgba(255,255,255,0.3)', fontSize: '10px', fontFamily: THEME.SANS, margin: 0, fontFeatureSettings: "'tnum' 1" }}>
        ...
        {status === 'ready' && (
          <>
            ...
            <div style={{ position: 'absolute', top: '8px', left: '10px', pointerEvents: 'none' }}>
              <span style={{ color: 'rgba(255,255,255,0.5)', fontSize: '10px', fontFamily: THEME.SANS, fontFeatureSettings: "'tnum' 1", background: 'rgba(0,0,0,0.45)', padding: '2px 6px', borderRadius: '8px' }}>
            ...
            <div style={{ position: 'absolute', bottom: '8px', right: '10px' }}>
              <a href={useAF ? `https://alphafold.ebi.ac.uk/entry/${alphafoldId}` : `https://www.rcsb.org/structure/${pdbId}`}
                ...
                style={{ color: 'rgba(255,255,255,0.55)', fontSize: '10px', fontFamily: THEME.SANS, fontFeatureSettings: "'tnum' 1", display: 'flex', alignItems: 'center', gap: '3px', textDecoration: 'none', background: 'rgba(0,0,0,0.45)', padding: '2px 6px', borderRadius: '8px' }}
      ...
      {alphafoldId && (
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '8px 12px', borderRadius: '16px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)' }}>
          <div>
            ...
            <p style={{ color: 'rgba(255,255,255,0.2)', fontSize: '10px', fontFamily: THEME.SANS, fontFeatureSettings: "'tnum' 1", margin: 0 }}>AI confidence coloring</p>
          </div>
        ...
        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
          {[{ c: '#0053D6', l: '>90' }, { c: '#65CBF3', l: '70–90' }, { c: '#FFDB13', l: '50–70' }, { c: '#FF7D45', l: '<50' }].map(x => (
            <div key={x.l} style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
              ...
              <span style={{ color: 'rgba(255,255,255,0.45)', fontSize: '10px', fontFamily: THEME.SANS, fontFeatureSettings: "'tnum' 1" }}>{x.l}</span>
            </div>
          ))}
        </div>
      )}
      ...
      <div style={{ padding: '10px 12px', borderRadius: '16px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)' }}>
        <p style={{ color: 'rgba(255,255,255,0.28)', fontSize: '10px', fontFamily: THEME.SANS, textTransform: 'uppercase', letterSpacing: '0.08em', margin: '0 0 6px' }}>
          Structure trace
        </p>
        <p style={{ color: 'rgba(255,255,255,0.68)', fontSize: '11px', lineHeight: 1.6, margin: '0 0 8px', fontFamily: THEME.SANS }}>
          {traceText}
        </p>
        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
          <span style={{ padding: '3px 8px', borderRadius: '999px', background: 'rgba(255,255,255,0.05)', color: 'rgba(255,255,255,0.55)', fontSize: '10px', fontFamily: THEME.SANS }}>
            source · {sourceLabel}
          </span>
          <span style={{ padding: '3px 8px', borderRadius: '999px', background: 'rgba(255,255,255,0.05)', color: 'rgba(255,255,255,0.55)', fontSize: '10px', fontFamily: THEME.SANS }}>
            mode · {renderMode}
      ...
      <p style={{ color: 'rgba(255,255,255,0.1)', fontSize: '10px', fontFamily: THEME.SANS, fontFeatureSettings: "'tnum' 1", margin: 0, textAlign: 'center' }}>
