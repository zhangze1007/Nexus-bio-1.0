    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, #BFDCCD 0%, #AFC3D6 50%, transparent 70%)",
          }}
        />
      </div>
        ...
        >
          ...
          >
            ...
            <span
              style={{
                background:
                  "linear-gradient(135deg, #BFDCCD 0%, #AFC3D6 50%, #CFC4E3 100%)",
          ...
          >
            Join thousands of synthetic biology researchers using Nexus-Bio to
            design, simulate, and optimize biological systems — all in one
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              ...
              style={{
                ...
                background:
                  "linear-gradient(135deg, #BFDCCD 0%, #AFC3D6 100%)",
                color: "#0d0f14",
          ...
          <p
            ...
            style={{ fontFamily: THEME.MONO, color: THEME.INK_SOFT }}
          >
