...
import { CELLFREE_TABS, GENE_COLORS, getIvivExpressionLabel, TimeCourseChart, ResourceChart, ReactorTwin3D } from './cellfree/sharedComponents';
import GeneConstructPanel from './cellfree/GeneConstructPanel';
import { FittingTabContent, CalibrateTabContent, IvIvTabContent } from './cellfree/ExpressionYieldPanel';
...
export default React.memo(function CellFreePage() {
  ...
  const {
    constructs, params, activeTab, setActiveTab,
    ...
    pipelineResult, pipelineLoading, pipelineError, setPipelineResult, setPipelineLoading, setPipelineError,
    handleCalibrate, handleBrendaLookup, handleApplyBrenda, handleClearBrenda, handleCsvUpload,
    result, simError, sim, fit, iviv, invitroMaxProtein, exportData,
  } = state;
