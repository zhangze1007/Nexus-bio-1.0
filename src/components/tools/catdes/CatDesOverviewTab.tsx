...
import { GLASS, LABEL, VALUE, type QualityIndicator } from './catdesShared';
import { ENZYME_STRUCTURES, PATHWAY_STEPS } from '../../../data/mockCatalystDesigner';
import type {
  EnzymeStructure, BindingAffinityResult, SequenceDesignResult,
  MetabolicDrainResult, PathwayBalanceResult, ParetoFrontResult,
  MutagenesisResult, BottleneckResult,
...
export default function CatDesOverviewTab({
  enzyme, binding, sequences, drain, balance, pareto, mutagenesis,
  bottlenecks, bestPathway, kdQ, kcatQ, fitQ, activeEnzyme,
