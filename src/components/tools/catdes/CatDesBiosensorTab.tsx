...
import { BORDER, dataCell, GLASS, hdrCell, INPUT_BG, INPUT_BORDER, INPUT_TEXT, LABEL, VALUE } from "./catdesShared";
      ...
      >
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
          <div>
            ...
            >
              {["arabinose", "IPTG", "aTc", "salicylate", "acyl-HSL", "theophylline", "vanillin", "erythromycin"].map(
                (lig) => (
      ...
      {bioResult && (
        <>
            ...
            <div style={{ ...GLASS, borderRadius: 16, padding: 14 }}>
              ...
              <div style={{ marginTop: 8, display: "flex", flexDirection: "column", gap: 4 }}>
                {[
                  ...
                  {
                    label: "Leak Expression",
                    value: `${(bioResult.leakExpression * 100).toFixed(2)}%`,
                    color: bioResult.leakExpression > 0.02 ? THEME.CORAL : THEME.MINT,
                  },
                  {
                    label: "Orthogonality",
                    value: `${(bioResult.orthogonality * 100).toFixed(0)}%`,
                    color: bioResult.orthogonality > 0.8 ? THEME.MINT : THEME.RISK_LOW,
                  },
                ].map((m) => (
          ...
          >
            ...
            <div>
              • TF: {bioResult.transcriptionFactor} — promoter: {bioResult.promoter}
            </div>
