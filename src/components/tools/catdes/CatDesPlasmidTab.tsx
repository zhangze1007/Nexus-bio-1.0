...
export default function CatDesPlasmidTab({
  plasmidResult, plasmidLoading, plasmidHost, setPlasmidHost,
  expressionLevel, setExpressionLevel, assemblyMethod, setAssemblyMethod,
  copyNumber, setCopyNumber, handlePlasmidDesign,
