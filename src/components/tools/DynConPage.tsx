...
import { BioprocessOptimizationPanel, TrajectoryPanel } from "./dyncon/BioreactorSim";
  ...
  return (
    <ToolShell
      ...
      footer={
        <>
          <DataSourceBadge
            source={fbaPayload || cethxPayload ? "live" : "mock"}
            label={fbaPayload || cethxPayload ? "Upstream Data" : "Default Params"}
          />
          ...
          <ScientificHero
            ...
            aside={
              <>
                ...
                >
                  Controller gains are translated into a concrete RBS choice, so the workbench keeps one foot in
                  executable biology.
                </div>
              </>
            }
              ...
              steps={[
                {
                  id: "setup",
                  label: "Setup",
                  status: workflowStep > 0 ? "done" : workflowStep === 0 ? "active" : "pending",
                  detail: "Controller params",
                },
                {
                  id: "simulate",
                  label: "Simulate",
                  status: workflowStep > 1 ? "done" : workflowStep === 1 ? "active" : "pending",
                  detail: controlMode === "mpc" ? "MPC" : "RK4 ODE",
                },
                {
                  id: "optimize",
                  label: "Optimize",
                  status: workflowStep > 2 ? "done" : workflowStep === 2 ? "active" : "pending",
                  detail: "Tune gains",
                },
                {
                  id: "analyze",
                  label: "Analyze",
                  status: workflowStep > 3 ? "done" : workflowStep === 3 ? "active" : "pending",
                  detail: "Convergence",
                },
              ]}
          ...
          <div style={{ padding: "0 16px 8px" }}>
            <ResultSummaryPanel
              metrics={[
                ...
                {
                  label: "Stability",
                  value: doRmse.toFixed(3),
                  unit: "RMSE",
                  accent: doRmse > 0.1 ? THEME.CORAL : THEME.SKY,
                  trend: doRmse > 0.1 ? "down" : "flat",
                },
              ]}
            />
          </div>
