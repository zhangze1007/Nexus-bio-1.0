...
import { DEFAULT_HILL, DEFAULT_PARAMS } from "../../../data/mockDynCon";
...
export function HillCurvePanel({ state }: { state: DynConStateReturn }) {
  const { vmax, setVmax, hillKd, setHillKd, hillN, setHillN, hill, currentFPP } = state;
        ...
        <InlineMetricOverlay
          ...
          metrics={[
            ...
            { label: "Hill coeff", value: hillN.toFixed(1), accent: THEME.APRICOT },
            {
              ...
              accent: currentFPP > DEFAULT_PARAMS.fppToxicThreshold ? THEME.CORAL : THEME.MINT,
            },
          ]}
        />
      </div>
