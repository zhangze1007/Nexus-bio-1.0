...
import { DEFAULT_PARAMS, DEFAULT_CONTROLLER } from '../../../data/mockDynCon';
...
import { StatRow, ParamSlider } from './sharedComponents';
...
export function ConvergencePanel({ state }: { state: DynConStateReturn }) {
  const {
    ...
    kp, ki, kd, setpoint, hill, controlMode,
    productTiter, productivity, last, doRmse, currentFPP, currentADS,
  } = state;
