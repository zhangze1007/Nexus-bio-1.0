...
import { DEFAULT_PARAMS, DEFAULT_CONTROLLER, DEFAULT_HILL, SPONTANEOUS_LOSS_RATE, O2_CONSUMPTION_COEFF } from '../../../data/mockDynCon';
...
import { TimeSeriesSVG, ParamSlider } from './sharedComponents';
...
export function TrajectoryPanel({ state }: { state: DynConStateReturn }) {
  const {
    ...
    mpcResult, trajectory, convergence,
    productTiter, doRmse, currentFPP, burden, rbsMapping, hill, chartRef,
  } = state;
