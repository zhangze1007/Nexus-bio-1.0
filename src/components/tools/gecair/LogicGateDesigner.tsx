...
import { viridisColor, resolveGateOutput, PART_COLORS } from './sharedComponents';

export function CircuitSVG({ inputA, inputB, gateType, view = 'full' }: { inputA: number; inputB: number; gateType: GateType; view?: 'full' | 'phasespace' | 'transfer' | 'dynamics' }) {
