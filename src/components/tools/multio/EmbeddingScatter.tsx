...
import type { OmicsLayer, EmbeddingPoint } from '../../../types';
...
export function EmbeddingScatter({ embeddings, fcThreshold, activeLayers, highlightedGene, bottleneckGene, geneFC }: {
