      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "12px" }}>
        <ScientificFigureFrame
          ...
          legend={[
            {
              label: "Status",
              value: mofaPlusResult ? (mofaPlusResult.converged ? "Converged" : "Max iter") : "Not run",
              accent: mofaPlusResult?.converged ? THEME.MINT : THEME.CORAL,
            },
        ...
        >
          ...
          {pipelineResult && (
            ...
            >
              <div style={{ fontFamily: THEME.MONO, fontSize: "var(--nb-fs-xs)", color: THEME.VALUE }}>
                {pipelineResult.topFactors} factors | {(pipelineResult.varianceExplained * 100).toFixed(1)}% var |{" "}
                {pipelineResult.dominantView}
              </div>
          ...
          {!mofaPlusResult && !mofaPlusLoading && (
            ...
            >
              ...
              <br />
              The model uses ARD priors for sparsity and coordinate ascent for inference.
            </div>
          )}
            ...
            <>
              ...
              <div style={{ display: "flex", gap: "12px", marginBottom: "20px", flexWrap: "wrap" }}>
                <div style={{ ...GLASS, borderRadius: "var(--nb-radius-md)", padding: "12px 16px", flex: "1 0 120px" }}>
                  ...
                  <span
                    style={{
                      ...
                      fontWeight: 700,
                      color: mofaPlusResult.converged ? THEME.MINT : THEME.CORAL,
                    }}
                  >
                ...
                <div style={{ ...GLASS, borderRadius: "var(--nb-radius-md)", padding: "12px 16px", flex: "1 0 120px" }}>
                  ...
                  >
                    {mofaPlusResult.factors[0]?.length ?? 0}
                  </span>
                </div>
                <div style={{ ...GLASS, borderRadius: "var(--nb-radius-md)", padding: "12px 16px", flex: "1 0 120px" }}>
                  <span style={{ fontFamily: THEME.SANS, fontSize: "var(--nb-fs-xs)", color: LABEL, display: "block" }}>
                  ...
                  return (
                    <SVGChartContainer W={chartW} H={chartH} ariaLabel="Variance explained per view" variant="paper">
                      {viewNames.map((vn, vi) => {
                        ...
                        const viewColor =
                          vn === "transcriptomics"
                            ? LAYER_COLORS.transcriptomics
                            : vn === "proteomics"
                              ? LAYER_COLORS.proteomics
                        ...
                        return (
                          <g key={vn}>
                            ...
                            <rect x={PAD_L} y={y} width={barAreaW} height={barH} fill={THEME.PANEL_INSET} rx={3} />
                            <rect
                              x={PAD_L}
                              y={y}
                ...
                {(() => {
                  ...
                  return (
                    <SVGChartContainer W={hmW} H={hmH} ariaLabel="Factor loadings heatmap" variant="paper">
                      ...
                      <rect
                        x={hmPAD_L + nFactors * cellW + 8}
                        y={hmPAD_T}
                        width="8"
                        height={viewNames.length * cellH - 2}
                        fill="url(#mofa-load-grad)"
                        rx="2"
                      />
                      <text
                        x={hmPAD_L + nFactors * cellW + 12}
                        y={hmPAD_T - 4}
                        fontFamily={THEME.MONO}
                        fontSize="9"
                        fill={LABEL}
                      ...
                      <text
                        x={hmPAD_L + nFactors * cellW + 12}
                        y={hmPAD_T + viewNames.length * cellH + 10}
                        fontFamily={THEME.MONO}
                        fontSize="9"
                        fill={LABEL}
                      >
                        ...
                        <div key={`factor-${fi}`} style={{ borderBottom: `1px solid ${BORDER}`, paddingBottom: "8px" }}>
                          ...
                          <div style={{ display: "flex", gap: "6px", flexWrap: "wrap" }}>
                            {top5.map((f, idx) => (
                              ...
                              >
                                {f.gene} <span style={{ opacity: 0.6 }}>({f.view.slice(0, 4)})</span>{" "}
                                {f.loading.toFixed(3)}
                              </span>
                            ))}
                          </div>
