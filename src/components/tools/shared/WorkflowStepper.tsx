        ...
        return (
          ...
          >
            ...
            >
              ...
              >
                {step.status === "done" ? (
                  <span style={{ fontFamily: THEME.MONO, fontSize: THEME.FS_XS, color: colors.text, fontWeight: 700 }}>
                    &#10003;
                  </span>
                ) : step.status === "error" ? (
                  <span style={{ fontFamily: THEME.MONO, fontSize: THEME.FS_SM, color: colors.text, fontWeight: 700 }}>
                    !
                  </span>
                ) : (
                  <span
