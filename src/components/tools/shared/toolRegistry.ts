...
export const TOOL_DEFINITIONS: ToolDefinition[] = [
  ...
  },
  {
    ...
    shell: 'bento',
    icon: Zap,
    summary: 'Condition-aware thermodynamics with Alberty-transformed delta-G prime, feasibility dashboard, and ATP yield analysis.',
  ...
  // ── Frontier engines (2025-2026) ──────────────────────────────────────
  {
    ...
    shell: 'ide',
    icon: Sparkles,
    summary: 'ProteinMPNN-style inverse folding: design amino acid sequences from backbone structure using graph neural message passing.',
    ...
    mode: 'design',
    threeDPotential: 'supporting',
    glossary: 'Inverse folding takes a protein backbone structure and designs amino acid sequences that would fold into it. Uses k-NN graph construction, multi-round message passing, and PSSM decoding.',
    keyConcepts: [{ term: 'Inverse folding', definition: 'Designing a sequence given a target 3D structure' }, { term: 'Message passing', definition: 'Graph neural network technique to propagate structural context' }, { term: 'PSSM', definition: 'Position-Specific Scoring Matrix for amino acid preferences' }],
  ...
  },
  {
    ...
    shell: 'ide',
    icon: Scissors,
    summary: 'Combinatorial CRISPR library design with epistasis-aware fitness prediction and MAGE cycling optimization.',
    ...
    mode: 'design',
    threeDPotential: 'none',
    glossary: 'Multiplex CRISPR designs combinatorial editing strategies for multiple genes simultaneously. It models epistatic interactions and predicts fitness of combinatorial variants.',
    keyConcepts: [{ term: 'Epistasis', definition: 'Non-additive interaction between genetic edits' }, { term: 'MAGE', definition: 'Multiplex Automated Genome Engineering — cycling through edits' }, { term: 'Combinatorial library', definition: 'Set of all possible combinations of edits' }],
  ...
  },
  {
    ...
    shell: 'ide',
    icon: GitBranch,
    summary: 'A* search over reaction database to discover novel biosynthetic pathways with thermodynamic feasibility scoring.',
    ...
    mode: 'design',
    threeDPotential: 'strong',
    glossary: 'Pathway Discovery uses graph search algorithms to find novel biosynthetic routes from available precursors to target molecules, scored by thermodynamic feasibility and enzyme availability.',
    keyConcepts: [{ term: 'A* search', definition: 'Informed graph search using heuristics to find optimal paths' }, { term: 'Atom economy', definition: 'Fraction of reactant atoms incorporated into the desired product' }, { term: 'ΔG cascade', definition: 'Cumulative free energy change along a pathway' }],
  ...
  },
  {
    ...
    mode: 'simulation',
    threeDPotential: 'none',
    glossary: 'Digital Twin maintains a probabilistic belief state of a bioreactor using Extended Kalman Filtering. It fuses sensor data with a process model and provides Monte Carlo forecasts.',
    keyConcepts: [{ term: 'Extended Kalman Filter', definition: 'Nonlinear state estimator using local linearization' }, { term: 'Sensor fusion', definition: 'Combining multiple noisy sensor readings into a coherent estimate' }, { term: 'Monte Carlo forecast', definition: 'Propagating uncertainty forward using random sampling' }],
