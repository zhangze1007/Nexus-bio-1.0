...
const SIZE_MAP: Record<
  ButtonSize,
  { height: string; padding: string; fontSize: string; gap: string; iconSize: number }
> = {
  ...
  return (
    <button
      ...
      style={{
        ...
        transition: "background 80ms, border-color 80ms, color 80ms, transform 120ms ease, box-shadow 120ms ease",
        whiteSpace: "nowrap",
        flexShrink: 0,
        ...styleProp,
      }}
