...
import { IJO1366_REACTIONS, IJO1366_GPR_RULES } from '../../../data/iJO1366Subset';
            ...
            return (
              <button
                ...
                style={{
                  ...
                  width: '100%', padding: '3px 6px', marginBottom: '1px',
        ...
        <div style={{ display: 'flex', gap: '6px', marginTop: '8px' }}>
          ...
          <button
            ...
            style={{
              ...
              fontFamily: THEME.SANS, fontSize: 'var(--nb-fs-xs)',
              fontWeight: 600, opacity: selectedGenes.length === 0 ? 0.5 : 1,
            }}
          >
      ...
      <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: '12px' }}>
        ...
        {koResult && (
          <div>
            ...
            <div style={{
              ...
              gap: '4px', maxHeight: '240px', overflow: 'auto',
            }}>
        ...
        {selectedGenes.length > 0 && !koResult && (
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', maxHeight: '300px', overflow: 'auto' }}>
              {IJO1366_REACTIONS
                .filter((rxn) => rxn.gpr && selectedGenes.some((g) => rxn.gpr!.includes(g)))
                .slice(0, 30)
                .map((rxn) => (
                  <div key={rxn.id} style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <span style={{ fontFamily: THEME.MONO, fontSize: 'var(--nb-fs-xs)', color: 'rgba(255,255,255,0.6)' }}>
                        {rxn.id}
                      </span>
                    ...
                    <div style={{
                      ...
                      color: 'rgba(200,216,232,0.6)', marginTop: '2px',
                      wordBreak: 'break-all',
                    }}>
                      {rxn.gpr}
                    </div>
        ...
        {selectedGenes.length === 0 && !koResult && (
          <div style={{
            ...
            color: 'rgba(255,255,255,0.3)', fontFamily: THEME.SANS, fontSize: 'var(--nb-fs-sm)',
            textAlign: 'center', padding: '24px',
          }}>
            Select one or more genes from the list on the left, then click "Knock out" to simulate the effect on the metabolic network.
          </div>
        )}
      </div>
    </div>
