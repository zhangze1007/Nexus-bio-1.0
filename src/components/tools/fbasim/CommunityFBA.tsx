...
import {
  REACTION_DEFS, YEAST_REACTION_DEFS, METABOLIC_NODES, FLUX_EDGES,
  YEAST_NODES, YEAST_FLUX_EDGES,
} from '../../../data/mockFBA';
...
type CommunityFBAProps = Pick<FBASimState,
  | 'ecoliGlucose' | 'setEcoliGlucose'
  | 'ecoliOxygen' | 'setEcoliOxygen'
  | 'ecoliKO' | 'setEcoliKO' | 'toggleEcoliKO'
  | 'yeastGlucose' | 'setYeastGlucose'
  | 'yeastOxygen' | 'setYeastOxygen'
  | 'yeastKO' | 'setYeastKO' | 'toggleYeastKO'
  | 'communityResult'
  | 'communityError' | 'setCommunityError'
  | 'communityLoading'
>;

export default function CommunityFBATab(props: CommunityFBAProps) {
  const {
    ecoliGlucose, setEcoliGlucose, ecoliOxygen, setEcoliOxygen,
    ecoliKO, toggleEcoliKO, setEcoliKO,
    yeastGlucose, setYeastGlucose, yeastOxygen, setYeastOxygen,
    yeastKO, toggleYeastKO, setYeastKO,
    communityResult, communityError, setCommunityError, communityLoading,
  } = props;
