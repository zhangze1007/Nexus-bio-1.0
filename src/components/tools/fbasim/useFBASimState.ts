...
import { round, createEmptyFBAOutput, createEmptyCommunityOutput, type SimMode } from './fbaHelpers';
import type {
  FSEOFResultType,
  OptKnockResultType,
  PipelineResult,
...
export function useFBASimState(): FBASimState {
  ...
  return {
    simMode, setSimMode, chartRef,
    glucoseUptake, setGlucoseUptake, oxygenUptake, setOxygenUptake,
    objective, setObjective, knockouts, setKnockouts,
    singleResult, singleRunProvenance, singleError, setSingleError, singleLoading,
    ecoliGlucose, setEcoliGlucose, ecoliOxygen, setEcoliOxygen, ecoliKO, setEcoliKO,
    yeastGlucose, setYeastGlucose, yeastOxygen, setYeastOxygen, yeastKO, setYeastKO,
    communityResult, communityRunProvenance, communityError, setCommunityError, communityLoading,
    fseofResult, setFseofResult, optknockResult, setOptknockResult,
    ...
    recommendedSeed, seedOverwriteNotice, setSeedOverwriteNotice, lastAppliedSeedRef,
    activeTab, setActiveTab,
    biggModels, biggResult, selectedModel, setSelectedModel, biggLoading,
    loadedReactions, loadedObjectiveId, modelLoading, handleLoadModel,
    toggleKO, toggleEcoliKO, toggleYeastKO,
    handleRunFSEOF, handleRunOptKnock, handleRunPipeline, handleSendToProEvol,
    top5, maxTopFlux, figureMeta, exportData, defaultStrainReactions,
  };
}
