...
export default function NextRoundRecommendationCard({ campaign }: { campaign: ProteinEvolutionCampaign }) {
  ...
  return (
    <ProEvolCard eyebrow="Next-Round Recommendation" title="Next round action">
      <div style={{ display: "grid", gap: "12px" }}>
        <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
          <StatusPill tone={recommendation.downstreamTransfer ? "cool" : "neutral"}>{recommendation.action}</StatusPill>
        ...
        <div
          style={{
            ...
            background:
              "linear-gradient(135deg, rgba(191,220,205,0.10) 0%, rgba(207,196,227,0.08) 48%, rgba(231,199,169,0.08) 100%)",
          }}
        >
          <div
            style={{
