...
import { formatSigned, PROEVOL_THEME, ProEvolCard, StatusPill, tableCellStyle, tableHeaderStyle } from "./shared";
                ...
                >
                  ...
                  <td
                    style={{
                      ...tableCellStyle(),
                      fontFamily: THEME.MONO,
                      color: variant.score.deltaFromWildType >= 0 ? PROEVOL_THEME.mint : PROEVOL_THEME.coral,
                    }}
                  >
                    {formatSigned(variant.score.deltaFromWildType, 1)}
                  </td>
                  <td style={{ ...tableCellStyle(), fontFamily: THEME.MONO }}>
                    {variant.predictedActivity.toFixed(1)}
                  </td>
                  <td style={{ ...tableCellStyle(), fontFamily: THEME.MONO }}>
                    {variant.predictedStability.toFixed(1)}
                  </td>
                  <td style={{ ...tableCellStyle(), fontFamily: THEME.MONO }}>
                    {variant.predictedExpression.toFixed(1)}
                  </td>
                  <td style={{ ...tableCellStyle(), fontFamily: THEME.MONO }}>
                    {variant.predictedSpecificity.toFixed(1)}
                  </td>
                  ...
                  <td style={{ ...tableCellStyle(), fontFamily: THEME.MONO }}>
                    ...
                    {variant.riskFlags.length ? (
                      <div style={{ fontSize: "var(--nb-fs-xs)", color: PROEVOL_THEME.label }}>
                        {variant.riskFlags.join(", ")}
                      </div>
                    ) : null}
                  </td>
