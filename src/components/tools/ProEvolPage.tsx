...
import { ChartShell, kicker } from "./proevol/sharedComponents";
    ...
    >
      {proevolError && (
        <div style={{ padding: "0 0 8px" }}>
          <SimErrorBanner message={proevolError} onRetry={() => setProevolError(null)} />
        </div>
      )}
            ...
            <div style={{ padding: "16px", display: "grid", gap: "12px" }}>
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
                  ...
                  <DataSourceBadge
                    source={pdbText ? "live" : "mock"}
                    label={pdbText ? "AlphaFold Live" : "AlphaFold"}
                  />
                </div>
                <textarea
                  ...
                  value={scanSequence}
                  onChange={(e) =>
                    setScanSequence(e.target.value.toUpperCase().replace(/[^ACDEFGHIKLMNPQRSTVWY]/g, ""))
                  }
                  style={{
                    width: "100%",
                    height: 60,
            ...
            <div style={{ padding: "16px" }}>
              <div style={{ display: "grid", gap: "12px" }}>
                <EvolutionCampaignContextCard
                  ...
                  selectionStringency={state.selectionStringency}
                  onTotalRoundsChange={state.setTotalRounds}
                  onLibrarySizeChange={state.setLibrarySize}
                  onSurvivorCountChange={state.setSurvivorCount}
                  onSelectionStringencyChange={state.setSelectionStringency}
                />
