  ...
  return (
    <div
      ...
      style={{
        ...
        flexShrink: 0,
        padding: "16px",
        borderLeft: `1px solid ${THEME.paperBorder}`,
    ...
    >
                ...
                {feedbackResult.qc_flags.map((flag: QCFlag, idx: number) => (
                  <div
                    ...
                    style={{
                      ...
                      marginBottom: "6px",
                      background:
                        flag.flag_type === "sensor_anomaly" ? "rgba(231,199,169,0.18)" : "rgba(232,163,161,0.18)",
                      border: `1px solid ${
                        flag.flag_type === "sensor_anomaly" ? "rgba(231,199,169,0.34)" : "rgba(232,163,161,0.34)"
                      }`,
                    }}
                  >
      ...
      {learnedDeltaPacks.length > 0 && (
        ...
        >
          <p style={{ ...sectionLabel, margin: "0 0 10px" }}>Delta Pack Approval Gate</p>
                ...
                >
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "2px", marginBottom: "8px" }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between" }}>
                      ...
                      <span style={{ fontFamily: THEME.MONO, fontSize: "var(--nb-fs-xs)", color: THEME.paperValue }}>
                        {pack.sourceExperimentRecordIds.length} record(s)
                      </span>
                    </div>
                  </div>
      ...
      {assemblyProvenance.length > 0 && (
        ...
        >
          <p style={{ ...sectionLabel, margin: "0 0 10px" }}>Data Provenance ({assemblyProvenance.length} records)</p>
            ...
            {assemblyProvenance.map((p) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span style={{ fontFamily: THEME.MONO, fontSize: "var(--nb-fs-xs)", color: clr }}>
                  ...
                  <p
                    style={{ fontFamily: THEME.MONO, fontSize: "var(--nb-fs-xs)", color: THEME.paperLabel, margin: 0 }}
                  >
                    {p.uuid}
                  </p>
                </div>
