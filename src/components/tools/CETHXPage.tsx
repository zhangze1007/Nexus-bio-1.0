...
import { CETHX_TABS, PATHWAYS } from "./cethx/sharedComponents";
  ...
  return (
    <ToolShell
          ...
          signals={[
            {
              ...
              detail: thermo.gibbs_free_energy < 0 ? "Thermodynamically favorable." : "Thermodynamically unfavorable.",
            ...
            {
              label: "Feasibility",
              value: feasibilityData.overallFeasible
                ? "All steps feasible"
                : `${feasibilityData.infeasibleCount} infeasible`,
              ...
              : []),
            {
              ...
              detail: equilibratorLoaded
                ? "ComponentContribution with uncertainty"
                : "Lehninger/NIST + Alberty transform (pre-computed)",
              tone: "cool" as const,
            },
          ]}
        />
      ...
      footer={
        <>
          <DataSourceBadge
            source={equilibratorLoaded ? "live" : "mock"}
            label={equilibratorLoaded ? "eQuilibrator Live" : "Pre-computed (Lehninger/NIST)"}
          />
          {fba && (
            <div
              role="status"
              style={{
                padding: "6px 14px",
                background: `${THEME.SKY}24`,
                border: `1px solid ${THEME.SKY}47`,
            ...
            >
              <span
                style={{
                  ...
                  padding: "2px 8px",
                  borderRadius: "999px",
                  background: `${THEME.SKY}38`,
                  border: `1px solid ${THEME.SKY}57`,
                  color: THEME.VALUE,
        ...
        <AlgorithmPanel
          ...
          limitations={
            [
              ...
              !equilibratorLoaded &&
                "Pre-computed values use fixed proton stoichiometry; eQuilibrator uses group contribution",
                ...
                >
                  <span
                    style={{
                      ...
                      fontWeight: 500,
                      color: pathway === p.id ? THEME.VALUE : THEME.LABEL,
                      display: "block",
                    }}
                  >
                    {p.label}
            ...
            <div style={{ marginTop: "16px", paddingTop: "12px", borderTop: `1px solid ${THEME.BORDER}` }}>
              ...
              <div style={{ display: "flex", gap: 4 }}>
                <input
                  ...
                  onKeyDown={(e) => {
                    if (e.key === "Enter") handleCompoundSearch();
                  }}
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 6,
                    padding: "4px 8px",
                    cursor: pubchemLoading ? "wait" : "pointer",
                ...
                >
                  ...
                  {pubchemData.molecularWeight > 0 && (
                    <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 2 }}>
                      ...
                      <span style={{ fontFamily: THEME.MONO, fontSize: "var(--nb-fs-xs)", color: THEME.VALUE }}>
                        {pubchemData.molecularWeight.toFixed(2)} g/mol
                      </span>
                    </div>
                  )}
              ...
              <div style={{ marginTop: 6 }}>
                <DataUpload
                  ...
                  onUpload={(rows, headers) => {
                    ...
                    const reactionCol = lowerHeaders.findIndex(
                      (h) => h === "reaction_id" || h === "reaction" || h === "step",
                    );
                    const deltaGCol = lowerHeaders.findIndex(
                      (h) => h === "deltag" || h === "delta_g" || h === "δg" || h === "dg",
                    );
              ...
              {pipelineResult && (
                ...
                >
                  <div style={{ fontFamily: THEME.MONO, fontSize: "var(--nb-fs-xs)", color: THEME.VALUE }}>
                    {pipelineResult.totalDeltaG.toFixed(1)} kJ/mol | {pipelineResult.atpYield.toFixed(0)} ATP |{" "}
                    {pipelineResult.efficiency.toFixed(1)}%
                  </div>
                  <div
                    style={{ fontFamily: THEME.MONO, fontSize: "var(--nb-fs-xxs)", color: THEME.LABEL, marginTop: 2 }}
                  >
          ...
          >
            <ScientificFigureFrame
              ...
              legend={[
                {
                  label: "Pathway",
                  value: PATHWAYS.find((entry) => entry.id === pathway)?.label ?? pathway,
              ...
              footer={
                <div style={{ fontFamily: THEME.MONO, fontSize: "var(--nb-fs-xs)", color: THEME.LABEL }}>
                  limiting step {limitingStep ?? "pending"} · entropy {thermo.entropy_production.toFixed(3)} · NADH{" "}
                  {thermo.nadh_yield.toFixed(1)}
                  {!equilibratorLoaded && (
              ...
              metrics={[
                {
                  label: "ΔG",
                  value: `${thermo.gibbs_free_energy.toFixed(1)} kJ/mol`,
                  accent: thermo.gibbs_free_energy < 0 ? THEME.MINT : THEME.CORAL,
                },
                { label: "ATP", value: `${thermo.atp_yield.toFixed(1)}`, accent: THEME.MINT },
