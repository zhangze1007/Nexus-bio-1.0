...
import type { GeneConstruct, CFSParameters } from '../../../services/CellFreeEngine';
...
export default function GeneConstructPanel({
  constructs, params, brendaApplied, brendaSource,
  pipelineLoading, pipelineError, pipelineResult, onRunPipeline,
