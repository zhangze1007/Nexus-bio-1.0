...
import type { CFSFullResult, GeneConstruct, CFSParameters, PlateReaderDataPoint } from '../../../services/CellFreeEngine';
...
import { FittingChart, IvIvChart, getIvivExpressionLabel, GENE_COLORS } from './sharedComponents';

const { glass: GLASS, label: LABEL, value: VALUE, inputBg: INPUT_BG, inputBorder: INPUT_BORDER, inputText: INPUT_TEXT, border: BORDER } = toolTokens;
...
export function FittingTabContent({
  result, params, fit, userData, brendaEcInput, brendaData, brendaSource,
  brendaLoading, brendaApplied, onCsvUpload, onClearUserData,
  onBrendaEcInputChange, onBrendaLookup, onApplyBrenda, onClearBrenda,
        ...
        <div style={{ ...GLASS, borderRadius: 'var(--nb-radius-md)', padding: '12px' }}>
          ...
          <div style={{ display: 'flex', gap: 6, marginBottom: 8 }}>
            <input
              ...
              onKeyDown={e => { if (e.key === 'Enter') onBrendaLookup(); }}
...
export function CalibrateTabContent({
  userData, calibrationResult, calibrationLoading, onCalibrate,
