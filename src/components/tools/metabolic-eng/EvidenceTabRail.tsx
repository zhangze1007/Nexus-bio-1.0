            ...
            signals={[
              ...
              },
              {
                ...
                detail:
                  ...
                  "No structured bottleneck has been injected from Analyze yet.",
              ...
              },
              {
                ...
                detail:
                  activeAnalyzeArtifact?.enzymeCandidates[0]?.label ?? "No enzyme candidate has been prioritized yet.",
                tone: "neutral",
              },
              {
                label: "Next Tool",
                ...
                detail:
                  "PATHD now makes the next scientific handoff explicit instead of leaving the route as a dead-end visualization.",
                tone: "warm",
              },
            ]}
          />
            ...
            items={[
              {
                title: "Route object",
                detail:
                  "The active route is treated as the canonical scientific object, so every downstream handoff inherits the same graph rather than rebuilding assumptions from scratch.",
              ...
              },
              {
                ...
                detail:
                  "The immersive pathway graph remains the main stage, but it is now framed by clear evidence and handoff language instead of reading like a standalone visual demo.",
                accent: THEME.SKY,
              ...
              },
              {
                ...
                detail:
                  "Bottlenecks, enzyme candidates, and next-tool routing stay visible so the page behaves like the front door to the rest of the workbench.",
                accent: THEME.MINT,
