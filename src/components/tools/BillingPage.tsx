...
const TIERS: TierInfo[] = [
  {
    ...
    features: ["All 14 simulation tools", "AI-assisted analysis", "Community support", "Public project sharing"],
    limits: [
  ...
  return (
    <div
      style={{
        ...
        ...(tier.highlight ? { boxShadow: "0 0 24px rgba(81,81,205,0.12)" } : {}),
      }}
    >
      {tier.highlight && (
        <div
...
export default React.memo(function BillingPage() {
  ...
  return (
    <ToolShell moduleId="billing" title="Billing & Subscription" description="Manage your Nexus-Bio plan and billing">
      {/* Status banner */}
      {success && (
        <div
          style={{
      ...
      >
        <strong style={{ color: THEME.SKY, fontFamily: THEME.MONO }}>Infrastructure Preview</strong> &mdash; Billing
        infrastructure is ready but not yet live. Stripe integration will activate once funding is secured. All tools
        remain free to use in the meantime.
      </div>
      ...
      >
        ...
        >
          {[
            ...
            const pct = usage.max === -1 ? 0 : Math.min(100, (usage.current / usage.max) * 100);
            return (
              <div key={usage.label}>
                <div
                  style={{
                ...
                >
                  ...
                  >
                    {usage.max === -1 ? `${usage.current}` : `${usage.current} / ${usage.max}`}
                  </span>
                </div>
                <div
                  style={{
                ...
                >
                  <div
                    style={{
                      height: "100%",
                      width: `${pct}%`,
                      background: pct > 80 ? THEME.CORAL : THEME.MINT,
                      borderRadius: 3,
