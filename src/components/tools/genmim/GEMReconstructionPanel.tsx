          ...
          >
            <span
              style={{
                ...
                height: "8px",
                borderRadius: "50%",
                background: gapFill ? THEME.MINT : "transparent",
          ...
          >
            <span
              style={{
                ...
                height: "8px",
                borderRadius: "50%",
                background: includeBiomass ? THEME.MINT : "transparent",
                border: `1px solid ${THEME.MINT}`,
                flexShrink: 0,
              }}
            />
          ...
          >
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(180px, 1fr))", gap: 8 }}>
              {(() => {
                ...
                return Array.from(subsystems.entries())
                  .sort((a, b) => b[1] - a[1])
                  .map(([sub, count]) => (
                    <div
                      key={sub}
                    ...
                    <tr key={r.id} style={{ background: i % 2 === 0 ? "transparent" : THEME.PANEL_INSET }}>
                      ...
                      <td
                        style={{
                          ...
                          fontSize: "var(--nb-fs-xs)",
                          padding: "4px 8px",
                          color: r.reversible ? THEME.MINT : THEME.LABEL,
                        }}
                      >
                        {r.reversible ? "Yes" : "No"}
                      </td>
      ...
      {!result && !loading && !error && (
        ...
        >
          ...
          <div style={{ fontFamily: THEME.MONO, fontSize: "var(--nb-fs-xxs)", color: THEME.DIM }}>
            {DEFAULT_ANNOTATIONS.length} E. coli K-12 annotations loaded across glycolysis, TCA, PPP, amino acid,
            nucleotide, cofactor, fatty acid, and transport subsystems.
          </div>
        </div>
      )}
    </div>
