        ...
        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "6px" }}>
          ...
          <span
            ...
            style={{
              ...
              fontWeight: 700,
              color: thermo.efficiency > 50 ? THEME.VALUE : THEME.CORAL,
            }}
          >
        ...
        >
          <motion.div
            ...
            style={{
              ...
              borderRadius: `${THEME.PROGRESS_RADIUS}px`,
              background:
                thermo.efficiency > 50
                  ? THEME.PROGRESS_GRADIENT
                  : `linear-gradient(90deg, ${THEME.CORAL}73, ${THEME.CORAL}F2)`,
            ...
            >
              ...
              <span
                style={{
                  ...
                  fontWeight: 600,
                  textAlign: "right",
                  color: s.deltaG < 0 ? THEME.MINT : THEME.CORAL,
                }}
              >
                {s.deltaG > 0 ? "+" : ""}
                {s.deltaG.toFixed(1)}
