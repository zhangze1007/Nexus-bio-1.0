...
import type { CETHXFeasibilityResult, CETHXThermoResult } from "./useCETHXState";
    ...
    <div style={{ flex: 1, overflowY: "auto", padding: "12px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "8px", marginBottom: "16px" }}>
        <MetricCard
          ...
          unit="kJ/mol"
          highlight={thermo.gibbs_free_energy < 0}
        />
      ...
      >
        ...
        <div
          style={{ display: "grid", gridTemplateColumns: "1fr 80px 100px 90px", gap: "2px 8px", alignItems: "center" }}
        >
          {/* Header */}
          <span
            style={{ fontFamily: THEME.MONO, fontSize: "var(--nb-fs-xxs)", color: THEME.DIM, letterSpacing: "0.06em" }}
          >
            STEP
          </span>
          <span
        ...
        <div style={{ fontFamily: THEME.SANS, fontSize: "var(--nb-fs-sm)", color: THEME.VALUE, lineHeight: 1.55 }}>
          ...
          {!equilibratorLoaded && (
            <span style={{ display: "block", marginTop: "6px", fontStyle: "italic", color: THEME.DIM }}>
              Note: per-step uncertainty is estimated at ~15% of |ΔG′| as a heuristic. For measured uncertainty from
              statistical thermodynamics, connect to the eQuilibrator backend.
            </span>
          )}
        </div>
      </div>
