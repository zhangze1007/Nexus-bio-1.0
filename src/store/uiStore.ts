...
import type { ConsoleEntry, PathwayEdge, PathwayNode } from "../types";
...
export const useUIStore = create<UIState>()(
  subscribeWithSelector((set) => ({
    ...
    resetPathway: () => set({ aiNodes: null, aiEdges: null, selectedNode: null }),

    openAuditTrail: (nodeId) => set({ auditTrailOpen: true, auditTrailNodeId: nodeId }),

    closeAuditTrail: () => set({ auditTrailOpen: false, auditTrailNodeId: null }),
