// Tool-specific types — FBA, ProEvol, GECAIR, DynCon, DBTL, MultiO, CETHX, GenMIM, NEXAI, SBOL
...
export interface ODEState {
  ...
  fpp?: number; // FPP intermediate concentration (uM)
...
export interface HillParams {
  ...
  Kd: number; // Dissociation constant (uM)
...
export interface ConvergenceMetrics {
  ...
  convergenceRate: number; // Exponential decay rate (h^-1)
