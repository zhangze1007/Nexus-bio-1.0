...
interface $3DmolViewer {
  ...
  setHoverable: (sel: Record<string, unknown>, hoverable: boolean, hoverCallback?: (...args: unknown[]) => void, unhoverCallback?: (...args: unknown[]) => void) => void;
  setClickable: (sel: Record<string, unknown>, clickable: boolean, callback?: (...args: unknown[]) => void) => void;
