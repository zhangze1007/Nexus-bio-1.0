...
function pushIssue(issues: ShowcaseTraceValidationIssue[], field: string, message: string): void {
  issues.push({ field, message });
}

function validateStep(value: unknown, field: string, issues: ShowcaseTraceValidationIssue[]): void {
  if (!isRecord(value)) {
...
function validateCommonFields(value: Record<string, unknown>, issues: ShowcaseTraceValidationIssue[]): void {
...
export function validateShowcaseTraceDocument(value: unknown): ShowcaseTraceValidationResult {
