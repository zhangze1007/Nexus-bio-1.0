...
export async function searchKEGGPathway(query: string): Promise<FallbackResult<KEGGPathwayResult>> {
...
export async function getKEGGCompound(compoundId: string): Promise<FallbackResult<KEGGCompoundResult>> {
