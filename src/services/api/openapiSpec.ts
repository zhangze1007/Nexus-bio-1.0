...
export const openapiSpec = {
  ...
  info: {
    title: "Nexus-Bio API",
    version: "1.0.0",
    description: "Synthetic Biology Operating System API — design, simulate, and optimize biological systems.",
    contact: {
      name: "Zhang Ze Foo",
  ...
  paths: {
    ...
    "/api/alphafold": {
      get: {
        ...
        description: "Proxy to EBI AlphaFold for PDB structure prediction by UniProt ID.",
    ...
    "/api/pubchem": {
      get: {
        ...
        description: "Proxy to PubChem REST API for compound data. Provide either cid or name.",
    ...
    "/api/equilibrator": {
      get: {
        ...
        description: "Proxy to eQuilibrator for standard reaction Gibbs energy estimates.",
    ...
    "/api/workbench": {
      get: {
        ...
        description: "Retrieve the current workbench project state including experiment ledger and decision trace.",
      ...
      put: {
        ...
        description: "Update workbench project state with revision conflict detection.",
