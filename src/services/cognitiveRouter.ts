...
const EXPLANATION_KEYWORDS = [
  'why', 'explain', 'reason', 'cause', 'how does', 'what makes',
  'compare', 'difference', 'trade-off', 'tradeoff', 'which',
  'recommend', 'suggest', 'should i', 'what next', 'advice',
  'interpret', 'meaning', 'implication', 'significance',
];
