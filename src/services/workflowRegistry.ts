...
const PATHD_CONTRACT: ToolContract = {
  ...
  outputArtifacts: [
    {
      toolId: "pathd",
      payloadPath: "result.pathwayCandidates",
      required: true,
      rationale: "Candidate routes for downstream FBA seeding.",
    },
    {
      toolId: "pathd",
      payloadPath: "nodeCount",
      required: true,
      rationale: "Pathway graph size; FBA requires non-zero nodes.",
    },
  ],
  evidenceRequired: { minItems: 1, kinds: ["literature", "analysis"], gateOnMissing: false },
  validityBaseline: {
    floor: "partial",
    reason: "Pathway graph + ΔG° lookup are real; route synthesis is template-based.",
  },
  ...
  failureModes: [
    {
      code: "NO_TARGET",
      detection: 'targetProduct empty or "Target Product"',
      recovery: "Provide a real target via /research or /analyze.",
    },
...
const FBASIM_CONTRACT: ToolContract = {
  ...
  requiredInputs: [
    {
      ...
      payloadPath: "result.pathwayCandidates",
      required: true,
      rationale: "FBA needs a candidate pathway to constrain.",
    },
  ],
  optionalInputs: [
    {
      toolId: "cethx",
      payloadPath: "result.gibbsFreeEnergy",
      required: false,
      rationale: "Demo reference thermodynamics may annotate flux work; it is not a formal feasibility constraint.",
    },
  ],
  outputArtifacts: [
    ...
    {
      toolId: "fbasim",
      payloadPath: "result.feasible",
      required: true,
      rationale: "LP feasibility flag for downstream gating.",
    },
  ],
  evidenceRequired: NO_EVIDENCE,
  validityBaseline: {
    floor: "partial",
    reason: "Single-species FBA uses real two-phase simplex LP. Community mode is post-hoc scaled.",
  },
  ...
  failureModes: [
    {
      code: "INFEASIBLE",
      detection: "result.feasible === false",
      recovery: "Loosen knockouts or revisit pathway design.",
    },
  ],
  demoPolicy: { allowsDemoSeed: true, blockGoldenPath: false },
  isGoldenPath: true,
...
const CATDES_CONTRACT: ToolContract = {
  ...
  requiredInputs: [
    {
      toolId: "fbasim",
      payloadPath: "result.topFluxes",
      required: true,
      rationale: "Catalyst targets are nominated by FBA bottlenecks.",
    },
  ],
  optionalInputs: [
    {
      toolId: "cethx",
      payloadPath: "result.efficiency",
      required: false,
      rationale: "Demo reference thermodynamic stress informs heuristic catalyst weighting.",
    },
  ],
  outputArtifacts: [
    {
      toolId: "catdes",
      payloadPath: "result.bestSequenceScore",
      required: true,
      rationale: "Best variant for DynCon expression seed.",
    },
  ...
  validityBaseline: {
    floor: "partial",
    reason: "Distance / orientation / VdW / electrostatic scoring is real; residue weights are curated.",
  },
  ...
  failureModes: [
    {
      code: "INVIABLE",
      detection: "result.isViable === false",
      recovery: "Reduce required flux or expand candidate library.",
    },
  ],
  demoPolicy: { allowsDemoSeed: true, blockGoldenPath: false },
  isGoldenPath: true,
  ...
  requiredInputs: [
    {
      ...
      payloadPath: "result.bestSequenceScore",
      required: true,
      rationale: "Controller tuning consumes catalyst expression bias.",
    },
  ],
  optionalInputs: [
    {
      toolId: "gecair",
      payloadPath: "result.outputLevel",
      required: false,
      rationale: "Gene-circuit dynamics inform controller bandwidth.",
    },
  ],
  outputArtifacts: [
    {
      toolId: "dyncon",
      payloadPath: "result.stable",
      required: true,
      rationale: "Stability flag gates CellFree simulation context.",
    },
    {
      toolId: "dyncon",
      payloadPath: "result.productTiter",
      required: true,
      rationale: "Predicted titer for cell-free seed.",
    },
  ],
  evidenceRequired: NO_EVIDENCE,
  validityBaseline: {
    floor: "partial",
    reason: "Hill feedback + Monod growth + RK4 ODE are textbook-correct; bioreactor parameters are reference values.",
  },
...
const CELLFREE_CONTRACT: ToolContract = {
  ...
  requiredInputs: [
    {
      ...
      payloadPath: "result.stable",
      required: true,
      rationale: "Cell-free prototyping inherits DynCon controller assumptions.",
    },
  ],
  optionalInputs: [
  ...
  outputArtifacts: [
    {
      toolId: "cellfree",
      payloadPath: "result.confidence",
      required: true,
      rationale: "CFPS heuristic confidence informs the DBTL Build/Test gate.",
    },
    {
      toolId: "cellfree",
      payloadPath: "result.invivoExpression",
      required: false,
      rationale: "Heuristic IVIV-translated yield estimate.",
    },
  ],
  evidenceRequired: NO_EVIDENCE,
  validityBaseline: {
    floor: "demo",
    reason:
      "Resource-aware TX-TL ODE structure exists, but parameter sourcing, calibration, and uncertainty remain incomplete.",
  },
  ...
  humanGatePolicy: {
    requiredFor: ["commit"],
    description: "Operator must commit prototype results before they enter the DBTL ledger.",
  },
  nextRecommendedNodes: ["dbtlflow", "multio"],
  failureModes: [
    {
      code: "RESOURCE_LIMITED",
      detection: "result.isResourceLimited === true",
      recovery: "Increase ATP/GTP or shorten simulation time.",
    },
  ],
  demoPolicy: { allowsDemoSeed: true, blockGoldenPath: false },
  isGoldenPath: true,
  ...
  requiredInputs: [
    {
      ...
      payloadPath: "result.confidence",
      required: true,
      rationale: "DBTL Test/Learn phases consume CFPS heuristic confidence.",
    },
  ],
  optionalInputs: [
    {
      ...
      payloadPath: "result.productTiter",
      required: false,
      rationale: "In-vivo titer estimate seeds Test scoring.",
    },
  ],
  outputArtifacts: [
    {
      toolId: "dbtlflow",
      payloadPath: "result.passRate",
      required: true,
      rationale: "Loop-back signal feeding the next iteration.",
    },
    {
      toolId: "dbtlflow",
      payloadPath: "result.feedback.learnedMetrics",
      required: true,
      rationale: "Typed learned metrics consumed by upstream seeders.",
    },
  ],
  evidenceRequired: NO_EVIDENCE,
  validityBaseline: {
    floor: "partial",
    reason: "Iteration ledger and SBOL serialization are real; learning loop weights are heuristic.",
  },
  confidencePolicy: { sourceField: "result.passRate", minToAdvance: 0 },
  uncertaintyPolicy: NO_UNCERTAINTY,
  humanGatePolicy: {
    requiredFor: ["commit", "loop-back"],
    description: "Operator must explicitly commit a Learn cycle before parameters re-seed upstream tools.",
  },
  nextRecommendedNodes: ["pathd", "fbasim", "multio", "scspatial"],
  failureModes: [
    {
      code: "NO_FEEDBACK",
      detection: 'feedbackSource !== "committed"',
      recovery: "Commit at least one Learn iteration to enable loop-back.",
    },
  ],
  demoPolicy: { allowsDemoSeed: true, blockGoldenPath: false },
  isGoldenPath: true,
...
const METABOLIC_ENG_CONTRACT: ToolContract = {
  ...
  optionalInputs: [
    {
      ...
      payloadPath: "result.pathwayCandidates",
      required: false,
      rationale: "3D lab consumes the active PATHD route when present.",
    },
  ],
  outputArtifacts: [],
  evidenceRequired: NO_EVIDENCE,
  validityBaseline: {
    floor: "partial",
    reason: "Same engine as PATHD with live FBA hooks; force layout is heuristic.",
  },
  ...
  optionalInputs: [
    {
      ...
      payloadPath: "result.pathwayCandidates",
      required: false,
      rationale: "Pathway choice selects the demo reference Delta-G cascade.",
    },
    {
      toolId: "fbasim",
      payloadPath: "result.topFluxes",
      required: false,
      rationale: "Flux context is attached for interpretation; it does not make CETHX condition-aware.",
    },
  ],
  outputArtifacts: [
    {
      ...
      payloadPath: "result.gibbsFreeEnergy",
      required: false,
      rationale: "Optional demo reference signal for CatDes scoring.",
    },
  ],
  evidenceRequired: NO_EVIDENCE,
  validityBaseline: {
    floor: "demo",
    reason:
      "Lehninger/NIST reference ΔG° values only; no condition-aware backend, uncertainty, ionic-strength, or pMg correction.",
  },
  confidencePolicy: NO_CONFIDENCE,
  uncertaintyPolicy: NO_UNCERTAINTY,
  humanGatePolicy: NO_GATE,
...
const PROEVOL_CONTRACT: ToolContract = {
  ...
  optionalInputs: [
    {
      ...
      payloadPath: "result.topFluxes",
      required: false,
      rationale: "Bottleneck enzymes nominate evolution targets.",
    },
    {
      toolId: "catdes",
      payloadPath: "result.bestSequenceScore",
      required: false,
      rationale: "Lead variant seeds the campaign WT.",
    },
  ],
  outputArtifacts: [],
  evidenceRequired: NO_EVIDENCE,
  validityBaseline: {
    floor: "partial",
    reason:
      "Campaign scoring and lineage tracking are deterministic heuristics; outputs are simulated decision support.",
  },
...
const GENMIM_CONTRACT: ToolContract = {
  ...
  optionalInputs: [
    {
      ...
      payloadPath: "result.topFluxes",
      required: false,
      rationale: "Flux constraints prioritize chassis edits.",
    },
  ],
  outputArtifacts: [],
  evidenceRequired: NO_EVIDENCE,
  validityBaseline: {
    floor: "partial",
    reason: "Greedy CRISPRi ranker is real; viability uses additive growth-impact (no epistatic interactions).",
  },
  confidencePolicy: NO_CONFIDENCE,
  uncertaintyPolicy: NO_UNCERTAINTY,
  humanGatePolicy: NO_GATE,
...
const GECAIR_CONTRACT: ToolContract = {
  ...
  optionalInputs: [
    {
      toolId: "genmim",
      payloadPath: "result.topGenes",
      required: false,
      rationale: "Chassis edits constrain insertion targets.",
    },
  ],
  outputArtifacts: [
    {
      ...
      payloadPath: "result.outputLevel",
      required: false,
      rationale: "Optional input to DynCon controller bandwidth.",
    },
  ],
  evidenceRequired: NO_EVIDENCE,
  validityBaseline: {
    floor: "partial",
    reason: "Hill curves and logic gate dynamics are real; circuit topology library is curated.",
  },
  confidencePolicy: NO_CONFIDENCE,
  uncertaintyPolicy: NO_UNCERTAINTY,
  humanGatePolicy: NO_GATE,
...
const MULTIO_CONTRACT: ToolContract = {
  ...
  optionalInputs: [
    {
      ...
      payloadPath: "result.passRate",
      required: false,
      rationale: "DBTL batches produce the measurements consumed here.",
    },
    {
      toolId: "cellfree",
      payloadPath: "result.confidence",
      required: false,
      rationale: "Prototype results can be merged with omics.",
    },
  ],
  outputArtifacts: [],
  evidenceRequired: NO_EVIDENCE,
  validityBaseline: {
    floor: "demo",
    reason:
      "Integration uses deterministic factor decomposition and linear embeddings; no Bayesian, GP, MOFA, VAE, or reference-model backend is implemented.",
  },
...
const SCSPATIAL_CONTRACT: ToolContract = {
  ...
  optionalInputs: [
    {
      toolId: "multio",
      payloadPath: "result.bottleneckGene",
      required: false,
      rationale: "Integrated omics findings seed spatial interrogation.",
    },
  ],
  outputArtifacts: [],
  evidenceRequired: NO_EVIDENCE,
  validityBaseline: {
    floor: "partial",
    reason: "h5ad ingestion, Moran I, neighborhood graphs, PAGA, UMAP are real when dataset fields are present.",
  },
  confidencePolicy: NO_CONFIDENCE,
  uncertaintyPolicy: NO_UNCERTAINTY,
  humanGatePolicy: NO_GATE,
...
const NEXAI_CONTRACT: ToolContract = {
  ...
  validityBaseline: {
    floor: "real",
    reason: "Answers come from Groq llama-3.3-70b-versatile via /api/analyze. No client-side template fallback.",
  },
  ...
  failureModes: [
    {
      code: "PROVIDER_DOWN",
      detection: "/api/analyze returns 503",
      recovery: "Wait or switch provider in the Vercel dashboard.",
    },
  ],
  demoPolicy: { allowsDemoSeed: true, blockGoldenPath: false },
  isGoldenPath: false,
...
const INVERSE_FOLDING_CONTRACT: ToolContract = {
  ...
  outputArtifacts: [
    {
      toolId: "inversefolding",
      payloadPath: "sequences",
      required: true,
      rationale: "Designed sequences from backbone structure.",
    },
  ],
  evidenceRequired: NO_EVIDENCE,
  validityBaseline: {
    floor: "partial",
    reason: "Real inverse folding algorithm with message passing + PSSM decoding.",
  },
  confidencePolicy: NO_CONFIDENCE,
  uncertaintyPolicy: NO_UNCERTAINTY,
  humanGatePolicy: NO_GATE,
...
const MULTIPLEX_CRISPR_CONTRACT: ToolContract = {
  ...
  outputArtifacts: [
    {
      toolId: "multiplexcrispr",
      payloadPath: "strategies",
      required: true,
      rationale: "Combinatorial CRISPR editing strategies.",
    },
  ],
  evidenceRequired: NO_EVIDENCE,
...
const PATHWAY_DISCOVERY_CONTRACT: ToolContract = {
  ...
  outputArtifacts: [
    {
      toolId: "pathwaydiscovery",
      payloadPath: "pathways",
      required: true,
      rationale: "Discovered biosynthetic pathways.",
    },
  ],
  evidenceRequired: NO_EVIDENCE,
...
const DIGITAL_TWIN_CONTRACT: ToolContract = {
  ...
  outputArtifacts: [
    {
      toolId: "digitaltwin",
      payloadPath: "currentState",
      required: true,
      rationale: "EKF-estimated bioreactor state.",
    },
  ],
  evidenceRequired: NO_EVIDENCE,
  ...
  failureModes: [
    {
      code: "NO_SENSOR_DATA",
      detection: "sensorReadings.length === 0",
      recovery: "Provide at least one sensor reading.",
    },
  ],
  demoPolicy: { allowsDemoSeed: true, blockGoldenPath: false },
  isGoldenPath: false,
