import type { CitationNode, NEXAIResult } from "../types";
...
export const MOCK_RESULTS: NEXAIResult[] = [
    ...
    citations: [
      {
        ...
        authors: "Ro DK, Paradise EM, Ouellet M et al.",
        year: 2006,
      ...
      {
        id: "c2",
        title: "Increased production of farnesyl diphosphate in Saccharomyces cerevisiae by overexpression of ERG20",
        authors: "Chambon C, Ladevèze V, Oulmouden A et al.",
        year: 1990,
        doi: "10.1007/BF00713466",
        relevance: 0.72,
        x: 180,
        y: 220,
      },
      {
        id: "c3",
        title: "Reconstitution of the biosynthesis of artemisinic acid in yeast using a single pathway",
        authors: "Paddon CJ, Westfall PJ, Pitera DJ et al.",
        year: 2013,
      ...
      {
        id: "c4",
        title: "Engineering of Saccharomyces cerevisiae for effective condensation of monoterpene",
        authors: "Jongedijk E, Cankar K, Ranzijn J et al.",
        year: 2016,
        doi: "10.1007/s00253-015-7081-7",
        relevance: 0.58,
        x: 110,
        y: 350,
      },
      {
        id: "c5",
        title: "Optimizing the expression of MVA pathway enzymes for production of isoprenoids",
        authors: "Westfall PJ, Pitera DJ, Lenihan JR et al.",
        year: 2012,
  ...
  },
  {
    ...
    citations: [
      {
        id: "c6",
        title: "Semi-synthetic artemisinin: a model for the use of synthetic biology in pharmaceutical development",
        authors: "Paddon CJ & Keasling JD",
        year: 2014,
      ...
      {
        id: "c7",
        title: "A recombinant yeast efficiently produces and secretes artemisinic acid",
        authors: "Teoh KH, Polichuk DR, Reed DW, Covello PS",
        year: 2006,
      ...
      {
        id: "c8",
        title: "Oxidative biosynthesis of artemisinic acid in Saccharomyces cerevisiae",
        authors: "Ro DK, Ouellet M, Paradise EM et al.",
        year: 2008,
        doi: "10.1021/jacs.8b00280",
        relevance: 0.78,
        x: 400,
        y: 240,
      },
  ...
  },
  {
    ...
    citations: [
      {
        id: "c9",
        title: "Dynamic control of gene regulatory networks and metabolic fluxes for metabolic engineering",
        authors: "Holtz WJ & Keasling JD",
        year: 2010,
      ...
      {
        id: "c10",
        title: "Optogenetic control of gene expression in S. cerevisiae",
        authors: "Zhao EM, Zhang Y, Mehl J et al.",
        year: 2018,
      ...
      {
        id: "c11",
        title: "Quorum sensing-based metabolic engineering",
        authors: "Soma Y, Tsuruno K, Wada M et al.",
        year: 2014,
