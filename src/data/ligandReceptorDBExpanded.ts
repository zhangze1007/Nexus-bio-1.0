...
export const EXPANDED_LR_DB: LRPairExpanded[] = [
  ...
  ...pairs(
    ['INHA', 'INHB'],
    ['ACVR1', 'ACVR2A', 'ACVR2B', 'TGFBR1', 'TGFBR2'],
    'Inhibin', 'growth_factor'
  ),
  ...pairs(
    ['LEFTY1', 'LEFTY2', 'NODAL'],
    ['ACVR1', 'ACVR2A', 'ACVR2B', 'TGFBR1', 'TGFBR2'],
  ...
  ...pairs(
    ['SHH', 'IHH', 'DHH'],
    ['PTCH1', 'PTCH2', 'SMO', 'BOC', 'CDON', 'GAS1'],
    'Hedgehog', 'growth_factor'
  ),
  ...
  ...pairs(
    ['IL3', 'IL5', 'CSF2'],
    ['CSF2RA', 'CSF2RB', 'IL3RA', 'IL5RA'],
    'IL-3/5/GM-CSF', 'cytokine'
  ),
  ...pairs(
    ['IL4', 'IL13'],
    ['IL4R', 'IL13RA1', 'IL13RA2', 'IL2RG'],
    'IL-4/13', 'cytokine'
  ),
  ...pairs(
  ...
  ...pairs(
    ['TNF', 'LTA', 'LTB'],
    ['TNFRSF1A', 'TNFRSF1B', 'LTBR'],
    'TNF', 'cytokine'
  ),
  ...pairs(
    ['FASLG', 'TNFSF10'],
    ['FAS', 'TNFRSF10A', 'TNFRSF10B', 'TNFRSF10C', 'TNFRSF10D'],
    'Apoptosis', 'cytokine'
  ),
  ...pairs(
  ...
  ...pairs(
    ...
    ['CCR1', 'CCR2', 'CCR3', 'CCR4', 'CCR5', 'CCR6', 'CCR7', 'CCR8', 'CCR9', 'CCR10', 'ACKR1', 'ACKR2', 'ACKR3', 'ACKR4'],
    'CCL', 'chemokine'
  ),
  ...pairs(
  ...
  ...pairs(
    ['COL1A1', 'COL1A2', 'COL2A1', 'COL3A1', 'COL4A1', 'COL4A2', 'COL4A3', 'COL4A4', 'COL4A5', 'COL4A6', 'COL5A1', 'COL5A2', 'COL5A3', 'COL6A1', 'COL6A2', 'COL6A3'],
    ['ITGA1', 'ITGA2', 'ITGA3', 'ITGA5', 'ITGAV', 'ITGB1', 'ITGB3', 'ITGB4', 'ITGB5'],
    'Collagen-Integrin', 'ecm'
  ),
  ...pairs(
    ['LAMA1', 'LAMA2', 'LAMA3', 'LAMA4', 'LAMA5', 'LAMB1', 'LAMB2', 'LAMB3', 'LAMC1', 'LAMC2', 'LAMC3'],
    ['ITGA1', 'ITGA2', 'ITGA3', 'ITGA6', 'ITGAV', 'ITGB1', 'ITGB4'],
    'Laminin-Integrin', 'ecm'
  ),
  ...pairs(
    ['FN1', 'VCAM1', 'ICAM1', 'ICAM2', 'ICAM3', 'ICAM4', 'ICAM5', 'THBS1', 'THBS2', 'THBS3', 'THBS4', 'VWF', 'VNN1', 'VNN2'],
    ['ITGA4', 'ITGA5', 'ITGAL', 'ITGAM', 'ITGAV', 'ITGB1', 'ITGB2', 'ITGB3', 'ITGB5', 'ITGB6', 'ITGB7', 'ITGB8'],
    'Fibronectin-Integrin', 'ecm'
  ),
  ...pairs(
  ...
  ...pairs(
    ...
    'Ephrin', 'growth_factor'
  ),

  // ── 16. Semaphorin Family ────────────────────────────────────────────
  ...pairs(
    ['SEMA3A', 'SEMA3B', 'SEMA3C', 'SEMA3D', 'SEMA3E', 'SEMA3F', 'SEMA3G', 'SEMA4A', 'SEMA4B', 'SEMA4C', 'SEMA4D', 'SEMA4F', 'SEMA4G', 'SEMA5A', 'SEMA5B', 'SEMA6A', 'SEMA6B', 'SEMA6C', 'SEMA6D', 'SEMA7A'],
    ['NRP1', 'NRP2', 'PLXNA1', 'PLXNA2', 'PLXNA3', 'PLXNA4', 'PLXNB1', 'PLXNB2', 'PLXNB3', 'PLXNC1', 'PLXND1'],
    'Semaphorin', 'growth_factor'
  ),
  ...
  ...pairs(
    ['KITLG', 'FLT3LG', 'CSF2'],
    ['KIT', 'FLT3', 'CSF2RA', 'CSF2RB'],
    'SCF-Kit', 'growth_factor'
  ),
  ...
  ...pairs(
    ['CLDN1', 'CLDN2', 'CLDN3', 'CLDN4', 'CLDN5', 'CLDN6', 'CLDN7', 'CLDN8', 'CLDN9', 'CLDN10', 'CLDN11', 'CLDN12', 'CLDN13', 'CLDN14', 'CLDN15', 'CLDN16', 'CLDN17', 'CLDN18', 'CLDN19', 'CLDN20', 'CLDN21', 'CLDN22', 'CLDN23', 'CLDN24', 'CLDN25', 'CLDN26', 'CLDN27'],
