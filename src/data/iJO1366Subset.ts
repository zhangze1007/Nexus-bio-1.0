...
export const IJO1366_STATS = {
  ...
  source: "e_coli_core (Orth, Fleming & Palsson 2010); COBRApy textbook model; growth 0.8739 h\u207b\u00b9 verified against COBRApy optimize()",
} as const;
